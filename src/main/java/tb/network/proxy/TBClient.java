...
public class TBClient extends TBServer {
    ...
    public Object getClientGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
        ...
        if (ID == 0x421922) {
            ...
            if (ID == 0x421921) return new GuiThaumicAnvil(player.inventory, world, x, y, z);

            if (ID == 0x421920) return new GuiVoidAnvil(player.inventory, world, x, y, z);

            if (ID == 0x421919) return new GuiRevolver(player.inventory, world, x, y, z);
        }
