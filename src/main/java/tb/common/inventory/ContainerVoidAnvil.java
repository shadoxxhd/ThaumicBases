...
public class ContainerVoidAnvil extends ContainerRepair {
    ...
    public ContainerVoidAnvil(InventoryPlayer inv, World w, int x, int y, int z, EntityPlayer p) {
        super(inv, w, x, y, z, p);
        thePlayer = p;
        ...
        this.addSlotToContainer(new Slot(this.outputSlot, 2, 134, 47) {
            ...
            public void onPickupFromSlot(EntityPlayer p_82870_1_, ItemStack p_82870_2_) {
                if (!p_82870_1_.capabilities.isCreativeMode) {
                    p_82870_1_.addExperienceLevel(-ContainerVoidAnvil.this.maximumCost);
                }
                ...
                if (ContainerVoidAnvil.this.stackSizeToBeUsedInRepair > 0) {
                    ...
                    if (itemstack1 != null
                        ...
                        ContainerVoidAnvil.this.inputSlots.setInventorySlotContents(1, (ItemStack) null);
                    }
                } else {
                    ContainerVoidAnvil.this.inputSlots.setInventorySlotContents(1, (ItemStack) null);
                }
