...
public class BlockRelocator extends BlockContainer {
    ...
    public IIcon getIcon(int side, int meta) {
        meta %= 6;
        if (meta == 0) return icons[side == 0 ? 0 : side == 1 ? 1 : 2];

        if (meta == 1) return icons[side == 1 ? 0 : side == 0 ? 1 : 2];

        if (meta == 2) return icons[side == 2 ? 0 : side == 3 ? 1 : side == 0 || side == 1 ? 2 : 4];

        if (meta == 3) return icons[side == 3 ? 0 : side == 2 ? 1 : side == 0 || side == 1 ? 2 : 4];

        if (meta == 4) return icons[side == 4 ? 0 : side == 5 ? 1 : 4];

        if (meta == 5) return icons[side == 5 ? 0 : side == 4 ? 1 : 4];
