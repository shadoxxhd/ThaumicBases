...
public class TBThaumonomicon {
	...
	public static void setup()
	{
		...
		//thauminite
		CrucibleRecipe thauminiteRec = new CrucibleRecipe("TB.Thauminite",new ItemStack(TBItems.resource,8,0),new ItemStack(ConfigItems.itemResource,1,2),new AspectList().add(Aspect.METAL, 4).add(Aspect.CRYSTAL, 8).add(Aspect.MAGIC, 2));
		...
		new ResearchItem("TB.DecoBlocks",catName,new AspectList(),0,2,0,new ItemStack(TBBlocks.quicksilverBlock,1,0))
		.setRound()
		.setAutoUnlock()
		.setPages(
		...
		new ResearchItem("TB.AdvancedEntropy",catName,new AspectList().add(Aspect.ENTROPY, 3).add(Aspect.MAGIC, 3).add(Aspect.CRAFT, 3),-3,2,1,new ItemStack(Items.blaze_powder,1,0))
		...
		new ResearchItem("TB.AlchemyRestoration",catName,new AspectList().add(Aspect.ORDER, 3).add(Aspect.MAGIC, 3).add(Aspect.CRAFT, 3),-3,4,1,new ItemStack(Blocks.packed_ice,1,0))
		.setParents("TB.CRUCIBLE")
		.setPages(
		...
		new ResearchItem("TB.Pyrofluid",catName,new AspectList().add(Aspect.FIRE, 16).add(Aspect.MAGIC, 6).add(Aspect.ELDRITCH, 8).add(Aspect.GREED, 6),1,6,4,new ItemStack(TBItems.pyroBucket,1,0))
		.setParents("TB.CRUCIBLE")
		.setPages(
		...
		new ResearchItem("TB.CrystalBlocks",catName,new AspectList().add(primals(8)),-4,5,1,new ItemStack(TBBlocks.crystalBlock,1,OreDictionary.WILDCARD_VALUE))
		...
		new ResearchItem("TB.Backprocessing",catName,new AspectList().add(Aspect.ORDER, 8).add(Aspect.EXCHANGE, 8).add(Aspect.CRAFT, 8),-6,3,1,new ItemStack(Items.reeds,1,0))
		...
		new ResearchItem("TB.MasterEntropy",catName,new AspectList().add(Aspect.ENTROPY, 8).add(Aspect.MAGIC, 4).add(Aspect.GREED, 2),-5,1,3,new ItemStack(Items.string,1,0))
		...
		new ResearchItem("TB.StrongEntropy",catName,new AspectList().add(Aspect.ENTROPY, 2).add(Aspect.WEAPON, 2),-1,1,3,new ItemStack(Blocks.sand,1,0))
		.setParents("TB.AdvancedEntropy")
		.setSecondary()
		.setPages(
		...
		new ResearchItem("TB.SimpleDublication",catName,new AspectList().add(Aspect.EXCHANGE, 6).add(Aspect.ORDER, 6),3,5,1,new ItemStack(Items.arrow,1,0))
		.setParents("TB.CRUCIBLE")
		.setSecondary()
		.setPages(
		...
		new ResearchItem("TB.Amber",catName,new AspectList().add(Aspect.TRAP, 6).add(Aspect.ORDER, 6),3,4,1,new ItemStack(ConfigItems.itemResource,1,6))
		.setParents("TB.CRUCIBLE")
		.setSecondary()
		.setPages(
		...
		new ResearchItem("TB.Quicksilver",catName,new AspectList().add(Aspect.TREE, 6).add(Aspect.ORDER, 6),3,2,1,new ItemStack(ConfigItems.itemResource,1,3))
		.setParents("TB.CRUCIBLE")
		.setSecondary()
		.setPages(
		...
		new ResearchItem("ROD_tbthaumium",catName,new AspectList().add(Aspect.METAL, 4).add(Aspect.MAGIC, 3).add(Aspect.AURA, 4).add(Aspect.CRAFT, 2).add(Aspect.MAN, 6),10,-1,2,new ItemStack(TBItems.resource,1,3))
		.setParents("TB.THAUMIUM")
		.setConcealed()
		.setPages(
		...
		new ResearchItem("ROD_tbvoid",catName,new AspectList().add(Aspect.ELDRITCH, 4).add(Aspect.MAGIC, 3).add(Aspect.AURA, 4).add(Aspect.VOID, 2).add(Aspect.MIND, 6),13,-1,4,new ItemStack(TBItems.resource,1,4))
		...
		new ResearchItem("CAP_thauminite",catName,new AspectList().add(Aspect.METAL, 4).add(Aspect.MAGIC, 3).add(Aspect.AURA, 4),5,0,2,new ItemStack(TBItems.resource,1,2))
		...
		new ResearchItem("TB.SM",catName,new AspectList().add(primals(4)),3,3,1,new ItemStack(ConfigItems.itemResource,1,14))
		...
		new ResearchItem("TB.SMB",catName,new AspectList().add(primals(6)).add(Aspect.CRAFT, 2),4,3,1,new ItemStack(TBBlocks.dustBlock))
		.setParents("TB.SM")
		.setConcealed()
		.setPages(
		...
		new ResearchItem("TB.OreDestruction",catName,new AspectList().add(Aspect.ENTROPY, 8).add(Aspect.MAGIC, 4).add(Aspect.ORDER, 1).add(Aspect.FIRE, 1).add(Aspect.AIR, 1).add(Aspect.EARTH, 1).add(Aspect.WATER, 1),-7,1,3,new ItemStack(ConfigItems.itemShard,1,OreDictionary.WILDCARD_VALUE))
		...
		.setConcealed()
		.setPages(
			new ResearchPage("tb.rec.enchantments.ewisdom"),
			new ResearchPage(elderKnowledgeEnch)
			).registerResearchItem();
		
		new ResearchItem("TB.EldritchBane",catName,new AspectList().add(Aspect.DEATH, 8).add(Aspect.ELDRITCH, 8).add(Aspect.WEAPON, 8),-1,10,1,new ResourceLocation("thaumicbases","textures/enchantments/eldritch_bane.png"))
		.setParents("TB.INFUSIONENCHANTMENT")
		.setSecondary()
		.setConcealed()
		.setPages(
			new ResearchPage("tb.rec.enchantments.ebane"),
			new ResearchPage(elderBaneEnch)
			).registerResearchItem();
		
		new ResearchItem("TB.MagicTouch",catName,new AspectList().add(Aspect.MAGIC, 8).add(Aspect.AURA, 8).add(Aspect.WEAPON, 8),-1,6,1,new ResourceLocation("thaumicbases","textures/enchantments/magic_touched.png"))
		.setParents("TB.INFUSIONENCHANTMENT")
		.setSecondary()
		.setConcealed()
		.setPages(
		...
		new ResearchItem("TB.Vaporising",catName,new AspectList().add(Aspect.MAGIC, 8).add(Aspect.CRYSTAL, 8).add(Aspect.TRAP, 8),-3,7,1,new ResourceLocation("thaumicbases","textures/enchantments/vaporising.png"))
		.setParents("TB.INFUSIONENCHANTMENT")
		.setSecondary()
		.setConcealed()
		.setPages(
			new ResearchPage("tb.rec.enchantments.vaporising"),
			new ResearchPage(vaporisingEnch)
			).registerResearchItem();
		
		new ResearchItem("TB.Tainted",catName,new AspectList().add(Aspect.TAINT, 16),-3,9,1,new ResourceLocation("thaumicbases","textures/enchantments/tainted.png"))
		.setParents("TB.INFUSIONENCHANTMENT")
		.setSecondary()
		.setConcealed()
		.setPages(
			new ResearchPage("tb.rec.enchantments.taint"),
		...
		new ResearchItem("TB.Foci.Drain",catName,new AspectList().add(Aspect.WATER, 6).add(Aspect.VOID, 3),-3,-2,0,new ItemStack(TBItems.fociDrain))
		...
		new ResearchItem("TB.Foci.Experience",catName,new AspectList().add(Aspect.GREED, 16).add(Aspect.HUNGER, 16).add(Aspect.MINE, 2).add(Aspect.MIND, 8),-2,-5 ,1,new ItemStack(TBItems.fociExperience))
		.setParents("TB.INFUSION")
		...
		new ResearchItem("TB.Foci.Flux",catName,new AspectList().add(Aspect.WATER, 4).add(Aspect.ORDER, 4).add(Aspect.VOID, 4),-2,-1,0,new ItemStack(TBItems.fociFlux))
		.setParents("TB.INFUSION")
		...
		new ResearchItem("TB.Foci.Activation",catName,new AspectList().add(Aspect.TRAVEL, 4).add(Aspect.MOTION, 4).add(Aspect.SENSES, 4),-3,-4,0,new ItemStack(TBItems.fociActivation))
		.setParents("TB.INFUSION")
		...
		new ResearchItem("TB.AdvAlc",catName,new AspectList().add(Aspect.MOTION, 16).add(Aspect.AIR, 16).add(Aspect.FIRE, 8).add(Aspect.CRAFT, 4),8,2,2,new ItemStack(TBBlocks.advAlchFurnace))
		...
		new ResearchItem("TB.CryingObs",catName,new AspectList().add(Aspect.TRAVEL, 8).add(Aspect.LIFE, 8).add(Aspect.SOUL, 8),3,-4,2,new ItemStack(TBBlocks.cryingObsidian,1,0))
		.setParents("TB.INFUSION")
		.setConcealed()
		.setPages(
		...
		new ResearchItem("TB.Overchanter",catName,new AspectList().add(primals(8)).add(Aspect.MIND, 8).add(Aspect.MAGIC, 8),-5,-3,3,new ItemStack(TBBlocks.overchanter,1,0))
		.setParents("TB.INFUSION")
		.setConcealed()
		.setPages(
		...
		new ResearchItem("TB.Relocator",catName,new AspectList().add(Aspect.MOTION, 4).add(Aspect.AIR, 4).add(Aspect.VOID, 4),6,7,1,new ItemStack(TBBlocks.relocator,1,0))
		...
		new ResearchItem("TB.ThaumicAnvil",catName,new AspectList().add(Aspect.METAL, 4).add(Aspect.CRAFT, 3),10,2,2,new ItemStack(TBBlocks.thaumicAnvil,1,0))
		.setParents("TB.THAUMIUM")
		.setConcealed()
		.setPages(
		...
		new ResearchItem("TB.VoidAnvil",catName,new AspectList().add(Aspect.METAL, 4).add(Aspect.CRAFT, 3).add(Aspect.TOOL,4).add(Aspect.ELDRITCH, 4),13,2,2,new ItemStack(TBBlocks.voidAnvil,1,0))
		...
		new ResearchItem("TB.Campfire",catName,new AspectList().add(Aspect.FIRE, 3).add(Aspect.MIND, 3).add(Aspect.ENTROPY, 3),9,5,1,new ItemStack(TBBlocks.campfire,1,0))
		.setRound()
		.setPages(
		...
		new ResearchItem("TB.Brazier",catName,new AspectList().add(Aspect.FIRE, 3).add(Aspect.MIND, 3).add(Aspect.ENTROPY, 3).add(Aspect.MAGIC, 3).add(Aspect.MOTION, 3),9,7,0,new ItemStack(TBBlocks.braizer,1,0))
		...
		if(TBConfig.allowTobacco)
		{
			...
			new ResearchItem("TB.Tobacco",catName,new AspectList().add(Aspect.CROP, 4).add(Aspect.HARVEST, 4).add(Aspect.MAN, 4).add(Aspect.MIND, 4),11,-7,3,new ItemStack(TBItems.greatwoodPipe,1,0))
			.setParentsHidden("TB.Plax")
			.setConcealed()
			.setPages(
			...
			new ResearchItem("TB.SilverwoodPipe",catName,new AspectList().add(Aspect.ORDER, 8).add(Aspect.HEAL, 8).add(Aspect.AURA, 8),13,-9,1,new ItemStack(TBItems.silverwoodPipe,1,0))
			...
			new ResearchItem("TB.Tobacco.Eldritch",catName,new AspectList().add(Aspect.DEATH, 4).add(Aspect.ELDRITCH, 4),14,-7,0,new ItemStack(TBItems.tobacco,1,1))
			.setParents("TB.Tobacco")
			.setParentsHidden("TB.INFUSION")
			.setConcealed()
			.setSecondary()
			...
			new ResearchItem("TB.Tobacco.Wispy",catName,new AspectList().add(Aspect.AURA, 4).add(Aspect.MAGIC, 4),15,-9,0,new ItemStack(TBItems.tobacco,1,8))
			.setParents("TB.Tobacco")
			.setParentsHidden("TB.INFUSION")
			.setConcealed()
			.setSecondary()
			...
			new ResearchItem("TB.Tobacco.Angry",catName,new AspectList().add(Aspect.WEAPON, 4).add(Aspect.HUNGER, 4),11,-9,0,new ItemStack(TBItems.tobacco,1,2))
			.setParents("TB.Tobacco")
			.setConcealed()
			.setSecondary()
			.setPages(
			...
			new ResearchItem("TB.Tobacco.Mining",catName,new AspectList().add(Aspect.MINE, 4).add(Aspect.MOTION, 4),8,-7,0,new ItemStack(TBItems.tobacco,1,5))
			.setParents("TB.Tobacco")
			.setConcealed()
			.setSecondary()
			.setPages(
			...
			new ResearchItem("TB.Tobacco.Wisdom",catName,new AspectList().add(Aspect.MIND, 4).add(Aspect.AIR, 4),13,-6,0,new ItemStack(TBItems.tobacco,1,4))
			.setParents("TB.Tobacco")
			.setConcealed()
			.setSecondary()
			.setPages(
			...
			new ResearchItem("TB.Tobacco.Tainted",catName,new AspectList().add(Aspect.MIND, 4).add(Aspect.TAINT, 4),15,-8,0,new ItemStack(TBItems.tobacco,1,7))
			.setParents("TB.Tobacco")
			.setConcealed()
			.setSecondary()
			.setPages(
			...
			new ResearchItem("TB.Tobacco.Saturating",catName,new AspectList().add(Aspect.FLESH, 4).add(Aspect.HUNGER, 4),10,-9,0,new ItemStack(TBItems.tobacco,1,3))
			.setParents("TB.Tobacco")
			.setConcealed()
			.setSecondary()
			.setPages(
			...
			new ResearchItem("TB.Tobacco.Sanity",catName,new AspectList().add(Aspect.ORDER, 4).add(Aspect.MIND, 4),9,-8,0,new ItemStack(TBItems.tobacco,1,6))
			.setParents("TB.Tobacco")
			.setConcealed()
			.setSecondary()
			.setPages(
		...
		if (TBConfig.enableBloodyMess) {
			...
			new ResearchItem("TB.Spike.Iron",catName,new AspectList().add(Aspect.WEAPON, 6).add(Aspect.HUNGER, 6).add(Aspect.METAL, 6),10,-3,1,new ItemStack(TBBlocks.spike,1,0))
			...
			new ResearchItem("TB.Spike.Thaumic",catName,new AspectList().add(Aspect.WEAPON, 6).add(Aspect.MAGIC, 6).add(Aspect.MECHANISM, 6),13,-3,1,new ItemStack(TBBlocks.spike,1,2))
			.setConcealed()
			...
			new ResearchItem("TB.BloodyRobes",catName,new AspectList().add(Aspect.HUNGER, 6).add(Aspect.FLESH, 6).add(Aspect.ARMOR, 6),12,-4,1,new ItemStack(TBItems.bloodyChest,1,0))
			.setConcealed()
			.setParents("TB.Spike.Iron")
			.setPages(
			...
			new ResearchItem("TB.Spike.Void",catName,new AspectList().add(Aspect.WEAPON, 6).add(Aspect.ELDRITCH, 6).add(Aspect.ARMOR, 6),15,-2,2,new ItemStack(TBBlocks.spike,1,4))
			.setConcealed()
		...
		if (TBConfig.enableBracelets) {
			...
			new ResearchItem("TB.Bracelet.Iron",catName,new AspectList().add(Aspect.METAL, 3).add(Aspect.MAGIC, 3),-6,7,0,new ItemStack(TBItems.castingBracelet,1,0))
			.setRound()
			.setPages(
			...
			new ResearchItem("TB.Bracelet.Gold",catName,new AspectList().add(Aspect.METAL, 3).add(Aspect.MAGIC, 3).add(Aspect.GREED, 3),-8,8,0,new ItemStack(TBItems.castingBracelet,1,1))
			...
			new ResearchItem("TB.Bracelet.Greatwood",catName,new AspectList().add(Aspect.TREE, 3).add(Aspect.MAGIC, 3).add(Aspect.ENERGY, 3),-10,8,0,new ItemStack(TBItems.castingBracelet,1,2))
			.setConcealed()
			...
			new ResearchItem("TB.Bracelet.Silverwood",catName,new AspectList().add(Aspect.ORDER, 3).add(Aspect.MAGIC, 3).add(Aspect.TREE, 3).add(Aspect.AURA, 3).add(Aspect.EXCHANGE, 3),-12,8,1,new ItemStack(TBItems.castingBracelet,1,4))
			.setConcealed()
			...
			new ResearchItem("TB.Bracelet.Primal",catName,primals(6).add(Aspect.MAGIC, 12).add(Aspect.ELDRITCH, 12),-17,8,4,new ItemStack(TBItems.castingBracelet,1,12))
			.setConcealed()
			.setSpecial()
			.setParents(
				"TB.ROD_primal_staff",
		...
		if (TBConfig.enableFlora) {
			...
			new ResearchItem("TB.Plax",catName,new AspectList().add(Aspect.CROP, 1).add(Aspect.CLOTH, 1),-11,-2,1,new ItemStack(TBItems.plaxSeed,1,0))
			...
			new ResearchItem("TB.Briar",catName,new AspectList().add(Aspect.CROP, 4).add(Aspect.PLANT, 4).add(Aspect.HEAL, 4),-13,-3,1,new ItemStack(TBItems.resource,1,6))
			.setParents("TB.Plax")
			.setConcealed()
			.setPages(
			...
			new ResearchItem("TB.Aurelia",catName,new AspectList().add(Aspect.LIFE, 6).add(Aspect.MAGIC, 6).add(Aspect.AURA, 6),-10,0,0,new ItemStack(TBBlocks.aurelia,1,0))
			.setParents("TB.BasicPlants")
			.setPages(
			...
			new ResearchItem("TB.Knose",catName,new AspectList().add(Aspect.LIFE, 6).add(Aspect.MIND, 6).add(Aspect.EARTH, 6),-10,2,0,new ItemStack(TBItems.knoseFragment,1,OreDictionary.WILDCARD_VALUE))
			...
			new ResearchItem("TB.Ashroom",catName,new AspectList().add(Aspect.LIFE, 6).add(Aspect.ENTROPY, 6).add(Aspect.AURA, 6).add(Aspect.AIR, 6).add(Aspect.CROP, 4),-9,2,2,new ItemStack(TBBlocks.ashroom))
			.setParents("TB.Aurelia")
			.setConcealed()
			.setPages(
			...
			new ResearchItem("TB.Glieonia",catName,new AspectList().add(Aspect.LIFE, 6).add(Aspect.LIGHT, 6).add(Aspect.SENSES, 6).add(Aspect.FIRE, 6).add(Aspect.PLANT, 4),-12,1,2,new ItemStack(TBItems.glieoniaSeed))
			.setParents("TB.Aurelia")
			.setConcealed()
			.setPages(
			...
			new ResearchItem("TB.Flaxium",catName,new AspectList().add(Aspect.LIFE, 6).add(Aspect.ENTROPY, 6).add(Aspect.AURA, 6).add(Aspect.MAGIC, 6),-11,2,2,new ItemStack(TBBlocks.flaxium))
			.setParents("TB.Aurelia")
			.setConcealed()
			.setPages(
			...
			new ResearchItem("TB.Metalleat",catName,new AspectList().add(Aspect.LIFE, 6).add(Aspect.MAGIC, 6).add(Aspect.METAL, 6).add(Aspect.EXCHANGE, 6),-10,-4,0,new ItemStack(TBItems.metalleatSeeds,1,0))
			.setParents("TB.BasicPlants")
			.setPages(
			...
			new ResearchItem("TB.Lazullia",catName,new AspectList().add(Aspect.LIFE, 6).add(Aspect.MAGIC, 6).add(Aspect.GREED, 6).add(Aspect.CRYSTAL, 6).add(Aspect.PLANT, 6).add(Aspect.SENSES, 8),-8,-5,2,new ItemStack(TBItems.lazulliaSeeds,1,0))
			...
			new ResearchItem("TB.RainbowCacti",catName,new AspectList().add(Aspect.LIFE, 6).add(Aspect.MAGIC, 6).add(Aspect.EXCHANGE, 6).add(Aspect.CROP, 6).add(Aspect.ENTROPY, 6).add(Aspect.SENSES, 8),-11,-6,2,new ItemStack(TBBlocks.rainbowCactus,1,0))
			.setParents("TB.Metalleat")
			.setConcealed()
			.setPages(
			...
			new ResearchItem("TB.Lucrite",catName,new AspectList().add(Aspect.GREED, 6).add(Aspect.MAGIC, 6).add(Aspect.PLANT, 6).add(Aspect.HUNGER, 6),-9,-6,0,new ItemStack(TBItems.lucriteSeeds,1,0))
			.setParents("TB.Metalleat")
			...
			new ResearchItem("TB.Redlon",catName,new AspectList().add(Aspect.LIFE, 6).add(Aspect.MECHANISM, 6).add(Aspect.ENERGY, 6).add(Aspect.CROP, 6).add(Aspect.ORDER, 6).add(Aspect.GREED, 8),-10,-6,3,new ItemStack(TBItems.redlonSeeds,1,0))
			.setParents("TB.Metalleat")
			.setConcealed()
			.setPages(
			...
			//void seed
			new ResearchItem("TB.VoidSeed",catName,new AspectList().add(Aspect.LIFE, 6).add(Aspect.ELDRITCH, 6).add(Aspect.DARKNESS, 6),16,3,1,new ItemStack(TBItems.voidSeed,1,0))
			...
			//saplings
			new ResearchItem("TB.GoldenOak",catName,new AspectList().add(Aspect.GREED, 8).add(Aspect.HUNGER, 8).add(Aspect.CROP, 8),-15,-1,0,new ItemStack(TBBlocks.sapling,1,0))
			.setParents("TB.Briar")
			.setParentsHidden("TB.INFUSION")
			.setConcealed()
			.setPages(
			...
			new ResearchItem("TB.PeacefulSapling",catName,new AspectList().add(Aspect.LIFE, 8).add(Aspect.HEAL, 8).add(Aspect.TREE, 8),-18,-1,0,new ItemStack(TBBlocks.sapling,1,1))
			...
			new ResearchItem("TB.NetherSapling",catName,new AspectList().add(Aspect.TREE, 8).add(Aspect.FIRE, 8).add(nether, 8),-17,0,0,new ItemStack(TBBlocks.sapling,1,2))
			.setParents("TB.GoldenOak")
			.setConcealed()
			.setPages(
			...
			new ResearchItem("TB.EnderSapling",catName,new AspectList().add(Aspect.TREE, 8).add(Aspect.ELDRITCH, 8).add(Aspect.VOID, 8),-17,-2,0,new ItemStack(TBBlocks.sapling,1,3))
			.setParents("TB.GoldenOak")
			.setConcealed()
			.setPages(
		...
		if (TBConfig.enableNodeTools) {
			...
			new ResearchItem("TB.NodeMan",catName,new AspectList().add(Aspect.MECHANISM, 8).add(Aspect.AURA, 8).add(Aspect.ENERGY, 16).add(Aspect.MAGIC, 8),0,-8,3,new ItemStack(TBBlocks.nodeManipulator))
			...
			new ResearchItem("TB.NodeFoci.Bright",catName,new AspectList().add(Aspect.AURA, 8).add(Aspect.LIGHT, 8),0,-11,0,new ItemStack(TBItems.nodeFoci,1,0))
			.setParents(bParents)
			.setConcealed()
			.setSecondary()
			.setPages(
			...
			new ResearchItem("TB.NodeFoci.Destr",catName,new AspectList().add(Aspect.AURA, 8).add(Aspect.DEATH, 8).add(Aspect.VOID, 8),2,-10,0,new ItemStack(TBItems.nodeFoci,1,1))
			...
			new ResearchItem("TB.NodeFoci.Efficiency",catName,new AspectList().add(Aspect.AURA, 8).add(Aspect.MAGIC, 8).add(Aspect.ENERGY, 8),-4,-8,0,new ItemStack(TBItems.nodeFoci,1,2))
			.setParents("TB.NodeMan")
			.setConcealed()
			.setSecondary()
			.setPages(
			...
			new ResearchItem("TB.NodeFoci.Hunger",catName,new AspectList().add(Aspect.AURA, 8).add(Aspect.HUNGER, 16).add(Aspect.ENERGY, 16),4,-9,0,new ItemStack(TBItems.nodeFoci,1,3))
			.setParents("TB.NodeMan")
			.setConcealed()
			.setSecondary()
			.setSpecial()
			...
			new ResearchItem("TB.NodeFoci.Unstable",catName,new AspectList().add(Aspect.AURA, 8).add(Aspect.ENTROPY, 8).add(Aspect.VOID, 8),-2,-10,0,new ItemStack(TBItems.nodeFoci,1,4))
			.setParents("TB.NodeMan")
			.setConcealed()
			.setSecondary()
			.setPages(
			...
			new ResearchItem("TB.NodeFoci.Purity",catName,new AspectList().add(Aspect.AURA, 8).add(Aspect.LIFE, 8).add(Aspect.ORDER, 8),-1,-11,0,new ItemStack(TBItems.nodeFoci,1,5))
			.setParents("TB.NodeMan")
			.setConcealed()
			.setSecondary()
			.setPages(
			...
			new ResearchItem("TB.NodeFoci.Sinister",catName,new AspectList().add(Aspect.AURA, 8).add(Aspect.UNDEAD, 8).add(Aspect.ENTROPY, 8),-3,-10,0,new ItemStack(TBItems.nodeFoci,1,6))
			.setParents("TB.NodeMan")
			.setConcealed()
			.setSecondary()
			.setPages(
			...
			new ResearchItem("TB.NodeFoci.Speed",catName,new AspectList().add(Aspect.AURA, 8).add(Aspect.MOTION, 8).add(Aspect.ENERGY, 8),-4,-9,0,new ItemStack(TBItems.nodeFoci,1,7))
			.setParents("TB.NodeMan")
			.setConcealed()
			.setSecondary()
			.setPages(
			...
			new ResearchItem("TB.NodeFoci.Stability",catName,new AspectList().add(Aspect.AURA, 8).add(Aspect.ORDER, 8).add(Aspect.EXCHANGE, 8),1,-11,0,new ItemStack(TBItems.nodeFoci,1,8))
			.setParents("TB.NodeMan")
			.setConcealed()
			.setSecondary()
			.setPages(
			...
			new ResearchItem("TB.NodeFoci.Taint",catName,new AspectList().add(Aspect.AURA, 8).add(Aspect.TAINT, 16).add(Aspect.ENERGY, 8),3,-10,0,new ItemStack(TBItems.nodeFoci,1,9))
			.setParents("TB.NodeMan")
			.setConcealed()
			.setSecondary()
			.setPages(
			...
			new ResearchItem("TB.NodeLinker",catName,new AspectList().add(Aspect.MECHANISM, 8).add(Aspect.AURA, 8).add(Aspect.TRAVEL, 16).add(Aspect.MAGIC, 8),5,-6,3,new ItemStack(TBBlocks.nodeLinker))
		...
		if (TBConfig.enableRevolver) {
			...
			new ResearchItem("TB.Revolver",catName,new AspectList().add(Aspect.WEAPON, 5).add(Aspect.FIRE, 5).add(Aspect.VOID, 4).add(Aspect.TOOL, 2).add(Aspect.ENERGY, 2),-16,-7,4,new ItemStack(TBItems.revolver,1,0))
			.setParentsHidden("TB.INFUSION")
			.setConcealed()
			.setPages(
			...
			new ResearchItem("TB.Revolver.Accuracy",catName,new AspectList().add(Aspect.ORDER, 8).add(Aspect.MECHANISM, 8).add(Aspect.SENSES, 4),-19,-7,0,new ResourceLocation("thaumicbases","textures/thaumonomicon/revolver/ACCURACY.png"))
			...
			new ResearchItem("TB.Revolver.Atropods",catName,new AspectList().add(Aspect.DEATH, 8).add(Aspect.BEAST, 8).add(Aspect.CLOTH, 4),-14,-10,0,new ResourceLocation("thaumicbases","textures/thaumonomicon/revolver/BANE_OF_ATROPODS.png"))
			.setParents("TB.Revolver")
			.setConcealed()
			.setSecondary()
			.setPages(
			...
			new ResearchItem("TB.Revolver.EldritchBane",catName,new AspectList().add(Aspect.DEATH, 8).add(Aspect.ELDRITCH, 4),-13,-8,0,new ResourceLocation("thaumicbases","textures/thaumonomicon/revolver/BANE_OF_ELDRITCH.png"))
			.setParents("TB.Revolver")
			.setConcealed()
			.setSecondary()
			.setPages(
			...
			new ResearchItem("TB.Revolver.Dueling",catName,new AspectList().add(Aspect.DEATH, 8).add(Aspect.MAN, 8),-15,-10,0,new ResourceLocation("thaumicbases","textures/thaumonomicon/revolver/DUELING.png"))
			.setParents("TB.Revolver")
			.setConcealed()
			.setSecondary()
			.setPages(
			...
			new ResearchItem("TB.Revolver.Efficiency",catName,new AspectList().add(Aspect.ORDER, 8).add(Aspect.EXCHANGE, 8),-19,-8,0,new ResourceLocation("thaumicbases","textures/thaumonomicon/revolver/EFFICIENCY.png"))
			.setParents("TB.Revolver")
			.setConcealed()
			.setSecondary()
			.setPages(
			...
			new ResearchItem("TB.Revolver.Eldritch",catName,new AspectList().add(Aspect.ELDRITCH, 8).add(Aspect.VOID, 8),-13,-7,0,new ResourceLocation("thaumicbases","textures/thaumonomicon/revolver/ELDRITCH.png"))
			.setParents("TB.Revolver")
			.setConcealed()
			.setSecondary()
			.setPages(
			...
			new ResearchItem("TB.Revolver.Heavy",catName,new AspectList().add(Aspect.WEAPON, 8).add(Aspect.METAL, 8),-19,-6,0,new ResourceLocation("thaumicbases","textures/thaumonomicon/revolver/HEAVY.png"))
			.setParents("TB.Revolver")
			.setConcealed()
			.setSecondary()
			.setPages(
			...
			new ResearchItem("TB.Revolver.Knowledge",catName,new AspectList().add(Aspect.MIND, 8).add(Aspect.MAGIC, 8),-18,-10,0,new ResourceLocation("thaumicbases","textures/thaumonomicon/revolver/KNOWLEGDE.png"))
			.setParents("TB.Revolver")
			.setConcealed()
			.setSecondary()
			.setPages(
			...
			new ResearchItem("TB.Revolver.Piercing",catName,new AspectList().add(Aspect.WEAPON, 8).add(Aspect.AIR, 8),-17,-10,0,new ResourceLocation("thaumicbases","textures/thaumonomicon/revolver/PIERCING.png"))
			.setParents("TB.Revolver")
			.setConcealed()
			.setSecondary()
			.setPages(
			...
			new ResearchItem("TB.Revolver.Power",catName,new AspectList().add(Aspect.WEAPON, 8).add(Aspect.MECHANISM, 8),-16,-10,0,new ResourceLocation("thaumicbases","textures/thaumonomicon/revolver/POWER.png"))
			.setParents("TB.Revolver")
			.setConcealed()
			.setSecondary()
			.setPages(
			...
			new ResearchItem("TB.Revolver.Primal",catName,new AspectList().add(Aspect.WEAPON, 8).add(Aspect.AURA, 8).add(primals(16)),-15,-5,0,new ResourceLocation("thaumicbases","textures/thaumonomicon/revolver/PRIMAL.png"))
			.setParents("TB.Revolver")
			.setConcealed()
			.setSecondary()
			.setSpecial()
			...
			new ResearchItem("TB.Revolver.Silver",catName,new AspectList().add(Aspect.DEATH, 8).add(Aspect.UNDEAD, 8),-13,-9,0,new ResourceLocation("thaumicbases","textures/thaumonomicon/revolver/SILVER.png"))
			.setParents("TB.Revolver")
			.setConcealed()
			.setSecondary()
			.setPages(
			...
			new ResearchItem("TB.Revolver.Speed",catName,new AspectList().add(Aspect.MOTION, 8).add(Aspect.AIR, 8),-19,-9,0,new ResourceLocation("thaumicbases","textures/thaumonomicon/revolver/SPEED.png"))
			.setParents("TB.Revolver")
			.setConcealed()
			.setSecondary()
			.setPages(
			...
			new ResearchItem("TB.Revolver.Tainted",catName,new AspectList().add(Aspect.TAINT, 8).add(Aspect.MAGIC, 8),-18,-4,0,new ResourceLocation("thaumicbases","textures/thaumonomicon/revolver/TAINTED.png"))
			.setParents("TB.Revolver")
			.setConcealed()
			.setSecondary()
			.setPages(
			...
			new ResearchItem("TB.Revolver.Void",catName,new AspectList().add(Aspect.VOID, 8).add(Aspect.METAL, 8),-19,-5,0,new ResourceLocation("thaumicbases","textures/thaumonomicon/revolver/VOID.png"))
			.setParents("TB.Revolver")
			.setConcealed()
			.setSecondary()
			.setPages(
