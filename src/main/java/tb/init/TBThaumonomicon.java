...
public class TBThaumonomicon {
    ...
    public static final ResourceLocation icon =
            new ResourceLocation("thaumicbases", "textures/thaumonomicon/bases1.png");
    ...
    public static void setup() {
        ...
        ThaumcraftApi.registerObjectTag(
                new ItemStack(TBBlocks.genLeaves, 1, 0), new int[] {0, 8}, new AspectList().add(Aspect.PLANT, 1));
        ThaumcraftApi.registerObjectTag(
        ...
        InfusionEnchantmentRecipe elderKnowledgeEnch = new InfusionEnchantmentRecipe(
                ...
                new ItemStack[] {
                    ...
                    new ItemStack(Items.paper, 1, 0),
                    new ItemStack(Items.paper, 1, 0),
                    new ItemStack(ConfigItems.itemZombieBrain, 1, 0),
                    new ItemStack(ConfigItems.itemResource, 1, 14)
                });
        ...
        InfusionEnchantmentRecipe taintedEnch = new InfusionEnchantmentRecipe(
                "TB.Tainted", TBEnchant.tainted, 5, new AspectList().add(Aspect.TAINT, 16), new ItemStack[] {
                    new ItemStack(ConfigItems.itemResource, 1, 11),
                    new ItemStack(ConfigItems.itemResource, 1, 12),
                    new ItemStack(ConfigItems.itemResource, 1, 14)
                });

        ShapelessArcaneRecipe salisMundusBlockRec =
                new ShapelessArcaneRecipe("TB.SMB", TBBlocks.dustBlock, new AspectList().add(primals(1)), new Object[] {
                    new ItemStack(ConfigItems.itemResource, 1, 14),
                    new ItemStack(ConfigItems.itemResource, 1, 14),
                    new ItemStack(ConfigItems.itemResource, 1, 14),
                    new ItemStack(ConfigItems.itemResource, 1, 14),
        ...
        toolsRec[4] = new ShapedArcaneRecipe(
                "TB.Thauminite", TBItems.thauminiteShears, primals(15), new Object[] {" #", "# ", '#', tiG});
        ...
        toolsRec[6] = new ShapedArcaneRecipe(
                "TB.Thauminite", TBItems.thauminiteHelmet, primals(25), new Object[] {"###", "# #", '#', tiG});

        toolsRec[7] = new ShapedArcaneRecipe(
                "TB.Thauminite", TBItems.thauminiteChest, primals(25), new Object[] {"# #", "###", "###", '#', tiG});

        toolsRec[8] = new ShapedArcaneRecipe(
                "TB.Thauminite", TBItems.thauminiteLeggings, primals(25), new Object[] {"###", "# #", "# #", '#', tiG});

        toolsRec[9] = new ShapedArcaneRecipe(
                "TB.Thauminite", TBItems.thauminiteBoots, primals(25), new Object[] {"# #", "# #", '#', tiG});

        ShapedArcaneRecipe thauminiteCaps = new ShapedArcaneRecipe(
                "CAP_thauminite", new ItemStack(TBItems.resource, 1, 2), primals(25), new Object[] {
                    "###",
                    "#@#",
                    "@@@",
                    '#',
        ...
        ShapedArcaneRecipe thaumicWandCore = new ShapedArcaneRecipe(
                "ROD_tbthaumium", new ItemStack(TBItems.resource, 1, 3), primals(50), new Object[] {
                    " @#",
                    "@#@",
                    "#@ ",
                    '#',
        ...
        for (int i = 0; i < 7; ++i)
            if (i < 6)
                cTaintedBlocks[i] = new CrucibleRecipe(
                        "TB.CrystalBlocks",
        ...
        for (int i = 0; i < oldRec.length; ++i)
            oldRec[i] = new ShapedArcaneRecipe(
                    "TB.DecoBlocks",
        ...
        ShapedArcaneRecipe thaumicAnvilRec = new ShapedArcaneRecipe(
                "TB.ThaumicAnvil", new ItemStack(TBBlocks.thaumicAnvil, 1, 0), primals(25), new Object[] {
                    "###",
                    " $ ",
                    "$$$",
                    '#',
        ...
        ShapelessOreRecipe voidIngotRec = new ShapelessOreRecipe(
                new ItemStack(ConfigItems.itemResource, 9, 16), new ItemStack(TBBlocks.voidBlock));
        ...
        new FakeResearchItem(
                        ...
                        0,
                        3,
                        ResearchCategories.getResearch("CRUCIBLE").icon_item)
        ...
        new FakeResearchItem(
                        ...
                        8,
                        0,
                        ResearchCategories.getResearch("THAUMIUM").icon_item)
                .registerResearchItem();
        new FakeResearchItem(
                        "TB.DISTILESSENTIA",
                        "THAUMICBASES",
                        ...
                        6,
                        2,
                        ResearchCategories.getResearch("DISTILESSENTIA").icon_item)
                .registerResearchItem();
        ...
        new FakeResearchItem(
                        ...
                        0,
                        -3,
                        ResearchCategories.getResearch("INFUSION").icon_item)
                .registerResearchItem();
        new FakeResearchItem(
                        "TB.BELLOWS",
                        "THAUMICBASES",
                        ...
                        6,
                        3,
                        ResearchCategories.getResearch("BELLOWS").icon_item)
                .registerResearchItem();
        new FakeResearchItem(
                        "TB.LEVITATOR",
                        "THAUMICBASES",
                        ...
                        6,
                        5,
                        ResearchCategories.getResearch("LEVITATOR").icon_item)
                .registerResearchItem();
        ...
        new FakeResearchItem(
                        ...
                        15,
                        1,
                        ResearchCategories.getResearch("VOIDMETAL").icon_item)
                .registerResearchItem();
        ...
        new ResearchItem(
                        ...
                        3,
                        1,
                        new ItemStack(TBBlocks.dustBlock))
                .setParents("TB.SM")
                .setConcealed()
        ...
        new ResearchItem(
                        ...
                        2,
                        2,
                        new ItemStack(TBBlocks.advAlchFurnace))
        ...
        new ResearchItem(
                        ...
                        5,
                        1,
                        new ItemStack(TBBlocks.campfire, 1, 0))
                .setRound()
        ...
        new ResearchItem(
                        ...
                        7,
                        0,
                        new ItemStack(TBBlocks.braizer, 1, 0))
        ...
        if (TBConfig.allowTobacco) {
            ...
            ShapelessArcaneRecipe pestleRecipe = new ShapelessArcaneRecipe(
                    "TB.Tobacco", TBItems.mortar, new AspectList().add(primals(4)), new Object[] {
            ...
            ShapedArcaneRecipe pipeRecipe = new ShapedArcaneRecipe(
                    "TB.Tobacco", TBItems.greatwoodPipe, new AspectList().add(primals(4)), new Object[] {
                        "#@ ",
                        " ##",
                        '#',
                        new ItemStack(ConfigBlocks.blockWoodenDevice, 1, 6),
        ...
        if (TBConfig.enableBloodyMess) {
            ...
            ShapedArcaneRecipe thaumiumSpikeRec = new ShapedArcaneRecipe(
                    "TB.Spike.Thaumic", new ItemStack(TBBlocks.spike, 1, 2), primals(4), new Object[] {
                        " * ",
                        "*#*",
                        "#_#",
                        '*',
            ...
            ShapedArcaneRecipe voidSpikeRec = new ShapedArcaneRecipe(
                    "TB.Spike.Void", new ItemStack(TBBlocks.spike, 1, 4), primals(4), new Object[] {
                        " * ",
                        "*#*",
                        "#_#",
                        '*',
        ...
        if (TBConfig.enableBracelets) {
            ...
            new FakeResearchItem(
                            ...
                            -8,
                            10,
                            ResearchCategories.getResearch("CAP_gold").icon_item)
                    .registerResearchItem();
            new FakeResearchItem(
                            "TB.ROD_greatwood",
                            "THAUMICBASES",
                            ...
                            -10,
                            6,
                            ResearchCategories.getResearch("ROD_greatwood").icon_item)
                    .registerResearchItem();
            new FakeResearchItem(
                            "TB.ROD_silverwood",
                            "THAUMICBASES",
                            ...
                            -12,
                            6,
                            ResearchCategories.getResearch("ROD_silverwood").icon_item)
                    .registerResearchItem();
            ...
            new FakeResearchItem(
                            ...
                            -19,
                            5,
                            ResearchCategories.getResearch("ROD_reed").icon_item)
                    .registerResearchItem();
            new FakeResearchItem(
                            "TB.ROD_blaze",
                            "THAUMICBASES",
                            ...
                            -15,
                            5,
                            ResearchCategories.getResearch("ROD_blaze").icon_item)
                    .registerResearchItem();
            new FakeResearchItem(
                            "TB.ROD_obsidian",
                            "THAUMICBASES",
                            ...
                            -19,
                            11,
                            ResearchCategories.getResearch("ROD_obsidian").icon_item)
                    .registerResearchItem();
            new FakeResearchItem(
                            "TB.ROD_ice",
                            "THAUMICBASES",
                            ...
                            -17,
                            5,
                            ResearchCategories.getResearch("ROD_ice").icon_item)
                    .registerResearchItem();
            new FakeResearchItem(
                            "TB.ROD_quartz",
                            "THAUMICBASES",
                            ...
                            -17,
                            11,
                            ResearchCategories.getResearch("ROD_quartz").icon_item)
                    .registerResearchItem();
            new FakeResearchItem(
                            "TB.ROD_bone",
                            "THAUMICBASES",
                            ...
                            -15,
                            11,
                            ResearchCategories.getResearch("ROD_bone").icon_item)
                    .registerResearchItem();
            ...
            new FakeResearchItem(
                            ...
                            -19,
                            8,
                            ResearchCategories.getResearch("ROD_primal_staff").icon_item)
                    .registerResearchItem();
            ...
            ShapedArcaneRecipe ironBraceletRec = new ShapedArcaneRecipe(
                    "TB.Bracelet.Iron", new ItemStack(TBItems.castingBracelet, 1, 0), primals(1), new Object[] {
                        "CIC",
                        "N N",
                        'C',
            ...
            ShapedArcaneRecipe goldBraceletRec = new ShapedArcaneRecipe(
                    "TB.Bracelet.Gold", new ItemStack(TBItems.castingBracelet, 1, 1), primals(5), new Object[] {
                        "CIC",
                        "N N",
                        'C',
            ...
            ShapedArcaneRecipe greatwoodBraceletRec = new ShapedArcaneRecipe(
                    "TB.Bracelet.Greatwood", new ItemStack(TBItems.castingBracelet, 1, 2), primals(25), new Object[] {
                        "CIC",
                        "I I",
                        'C',
                        new ItemStack(ConfigItems.itemWandCap, 1, 1),
            ...
            ShapedArcaneRecipe thaumiumBraceletRec = new ShapedArcaneRecipe(
                    "TB.Bracelet.Thaumium", new ItemStack(TBItems.castingBracelet, 1, 3), primals(25), new Object[] {
                        "CIC",
                        "INI",
                        "N N",
                        'C',
            ...
            new ResearchItem(
                    ...
                    .setPages(
                            new ResearchPage("tb.rec.bracelet.thaumium.page.0"), new ResearchPage(thaumiumBraceletRec))
                    .registerResearchItem();
        ...
        if (TBConfig.enableFlora) {
            ...
            new ResearchItem(
                            ...
                            2,
                            2,
                            new ItemStack(TBBlocks.ashroom))
                    .setParents("TB.Aurelia")
                    .setConcealed()
            ...
            new ResearchItem(
                            ...
                            1,
                            2,
                            new ItemStack(TBItems.glieoniaSeed))
                    .setParents("TB.Aurelia")
                    .setConcealed()
            ...
            new ResearchItem(
                            ...
                            2,
                            2,
                            new ItemStack(TBBlocks.flaxium))
                    .setParents("TB.Aurelia")
                    .setConcealed()
            ...
            new ResearchItem(
                            ...
                            -6,
                            2,
                            new ItemStack(TBBlocks.rainbowCactus, 1, 0))
                    .setParents("TB.Metalleat")
                    .setConcealed()
            ...
            new ResearchItem(
                            ...
                            -6,
                            3,
                            new ItemStack(TBItems.redlonSeeds, 1, 0))
                    .setParents("TB.Metalleat")
                    .setConcealed()
        ...
        if (TBConfig.enableNodeTools) {
            ...
            new FakeResearchItem(
                            ...
                            -2,
                            -7,
                            ResearchCategories.getResearch("NODESTABILIZERADV").icon_item)
                    .registerResearchItem();
            new FakeResearchItem(
                            "TB.VISPOWER",
                            "THAUMICBASES",
                            ...
                            2,
                            -7,
                            ResearchCategories.getResearch("VISPOWER").icon_item)
                    .registerResearchItem();
            ...
            ShapedArcaneRecipe nodeLinkRec = new ShapedArcaneRecipe(
                    "TB.NodeLinker", new ItemStack(TBBlocks.nodeLinker, 1, 0), primals(5), new Object[] {
                        "TPT",
                        "ANA",
                        "BOB",
                        'T',
        ...
        if (TBConfig.enableRevolver) {
            ...
            new ResearchItem(
                            ...
                            new ResourceLocation(
                                    "thaumicbases", "textures/thaumonomicon/revolver/BANE_OF_ATROPODS.png"))
                    .setParents("TB.Revolver")
                    .setConcealed()
                    .setSecondary()
            ...
            new ResearchItem(
                            ...
                            0,
                            new ResourceLocation(
                                    "thaumicbases", "textures/thaumonomicon/revolver/BANE_OF_ELDRITCH.png"))
                    .setParents("TB.Revolver")
                    .setConcealed()
                    .setSecondary()
        ...
        ShapedOreRecipe voidFlint = new ShapedOreRecipe(new ItemStack(TBItems.voidFAS), new Object[] {
            "# ", " C", '#', new ItemStack(ConfigItems.itemResource, 1, 16), 'C', new ItemStack(Items.flint)
        });

        ResearchItem voidIngot =
                ResearchCategories.getResearchList("ELDRITCH").research.get("VOIDMETAL");
        ...
        new ResearchItem(
                        ...
                        -3,
                        1,
                        new ItemStack(ConfigBlocks.blockCrystal, 1, OreDictionary.WILDCARD_VALUE))
