...
public class TBThaumonomicon {
    ...
    public static void setup() {
        ...
        ThaumcraftApi.registerObjectTag(
                ...
                new AspectList().add(Aspect.FIRE, 16).add(Aspect.MAGIC, 8).add(Aspect.LIGHT, 6));
        ThaumcraftApi.registerObjectTag(
        ...
        ThaumcraftApi.registerObjectTag(
                ...
                new AspectList().add(Aspect.CROP, 1).add(Aspect.CLOTH, 1));
        ThaumcraftApi.registerObjectTag(
                new ItemStack(TBBlocks.aurelia, 1, OreDictionary.WILDCARD_VALUE),
                new AspectList().add(Aspect.PLANT, 1).add(Aspect.AURA, 3).add(Aspect.LIGHT, 1).add(Aspect.SENSES, 1)
                        .add(Aspect.LIFE, 1));
        ThaumcraftApi.registerObjectTag(
                new ItemStack(TBBlocks.aureliaPetal, 1, OreDictionary.WILDCARD_VALUE),
                new AspectList().add(Aspect.PLANT, 1).add(Aspect.AURA, 6).add(Aspect.SENSES, 1));
        ThaumcraftApi.registerObjectTag(
                new ItemStack(TBItems.resource, 1, 5),
                new AspectList().add(Aspect.PLANT, 1).add(Aspect.AURA, 6));
        ThaumcraftApi.registerObjectTag(
                new ItemStack(TBItems.resource, 1, 6),
                new AspectList().add(Aspect.PLANT, 1).add(Aspect.HEAL, 1));
        ThaumcraftApi.registerObjectTag(
                new ItemStack(TBItems.resource, 1, 7),
                new AspectList().add(Aspect.PLANT, 1).add(Aspect.MAN, 1));
        ThaumcraftApi.registerObjectTag(
                new ItemStack(TBItems.tobacco, 1, 0),
                new AspectList().add(Aspect.PLANT, 1).add(Aspect.MAN, 1).add(Aspect.ENTROPY, 0));
        ThaumcraftApi.registerObjectTag(
                new ItemStack(TBItems.mortar, 1, OreDictionary.WILDCARD_VALUE),
                new AspectList().add(Aspect.TREE, 6).add(Aspect.TOOL, 1));

        ThaumcraftApi.registerObjectTag(
                new ItemStack(TBItems.knoseFragment, 1, 0),
                new AspectList().add(Aspect.PLANT, 1).add(Aspect.AIR, 6));
        ThaumcraftApi.registerObjectTag(
                new ItemStack(TBItems.knoseFragment, 1, 1),
                new AspectList().add(Aspect.PLANT, 1).add(Aspect.FIRE, 6));
        ThaumcraftApi.registerObjectTag(
                new ItemStack(TBItems.knoseFragment, 1, 2),
                new AspectList().add(Aspect.PLANT, 1).add(Aspect.WATER, 6));
        ThaumcraftApi.registerObjectTag(
                new ItemStack(TBItems.knoseFragment, 1, 3),
                new AspectList().add(Aspect.PLANT, 1).add(Aspect.EARTH, 6));
        ThaumcraftApi.registerObjectTag(
                new ItemStack(TBItems.knoseFragment, 1, 4),
                new AspectList().add(Aspect.PLANT, 1).add(Aspect.ORDER, 6));
        ThaumcraftApi.registerObjectTag(
                new ItemStack(TBItems.knoseFragment, 1, 5),
                new AspectList().add(Aspect.PLANT, 1).add(Aspect.ENTROPY, 6));
        ThaumcraftApi.registerObjectTag(
                new ItemStack(TBItems.knoseFragment, 1, 6),
                new AspectList().add(Aspect.PLANT, 1).add(primals(2)));
        ThaumcraftApi.registerObjectTag(
                new ItemStack(TBItems.knoseFragment, 1, 7),
                new AspectList().add(Aspect.PLANT, 1).add(Aspect.TAINT, 6));
        ...
        ThaumcraftApi.registerObjectTag(
                ...
                new int[] { 1, 9 },
                new AspectList().add(Aspect.PLANT, 1).add(Aspect.LIFE, 1));
        ThaumcraftApi.registerObjectTag(
                new ItemStack(TBBlocks.genLeaves, 1, 2),
                new int[] { 2, 10 },
                new AspectList().add(Aspect.PLANT, 1).add(nether, 1));
        ThaumcraftApi.registerObjectTag(
                new ItemStack(TBBlocks.genLeaves, 1, 3),
                new int[] { 3, 11 },
                new AspectList().add(Aspect.PLANT, 1).add(Aspect.ELDRITCH, 1));

        ThaumcraftApi.registerObjectTag(
                new ItemStack(TBBlocks.genLogs, 1, 0),
                new int[] { 0, 4, 8 },
                new AspectList().add(Aspect.TREE, 3).add(Aspect.HEAL, 1).add(Aspect.LIFE, 1));
        ThaumcraftApi.registerObjectTag(
                new ItemStack(TBBlocks.genLogs, 1, 1),
                new int[] { 1, 5, 9 },
                new AspectList().add(Aspect.TREE, 3).add(Aspect.FIRE, 1).add(nether, 1));
        ThaumcraftApi.registerObjectTag(
                new ItemStack(TBBlocks.genLogs, 1, 2),
                new int[] { 2, 6, 10 },
                new AspectList().add(Aspect.TREE, 3).add(Aspect.ELDRITCH, 1).add(Aspect.VOID, 1));

        ThaumcraftApi.registerObjectTag(
                new ItemStack(TBBlocks.sapling, 1, 0),
                new int[] { 0, 8 },
                new AspectList().add(Aspect.PLANT, 3).add(Aspect.GREED, 1));
        ThaumcraftApi.registerObjectTag(
        ...
        ThaumcraftApi.registerObjectTag(
                ...
                new int[] { 2, 10 },
                new AspectList().add(Aspect.PLANT, 3).add(nether, 1));
        ThaumcraftApi.registerObjectTag(
                new ItemStack(TBBlocks.sapling, 1, 3),
                new int[] { 3, 11 },
                new AspectList().add(Aspect.PLANT, 3).add(Aspect.ELDRITCH, 1));
        ThaumcraftApi.registerObjectTag(
                new ItemStack(TBItems.fociExperience, 1, 0),
                new AspectList().add(Aspect.METAL, 24).add(Aspect.GREED, 17).add(Aspect.CRYSTAL, 12)
                        .add(Aspect.EARTH, 7).add(Aspect.VOID, 5).add(Aspect.HUNGER, 5));
        ...
        CrucibleRecipe wool4Rec = new CrucibleRecipe(
                ...
                new ItemStack(Blocks.wool, 1, OreDictionary.WILDCARD_VALUE),
                new AspectList().add(Aspect.ENTROPY, 1).add(Aspect.CRAFT, 1));
        ...
        CrucibleRecipe salisMundis = new CrucibleRecipe(
                ...
                new AspectList().add(primals(2)).add(Aspect.MAGIC, 3));
        ...
        InfusionEnchantmentRecipe elderBaneEnch = new InfusionEnchantmentRecipe(
                ...
                2,
                new AspectList().add(Aspect.DEATH, 8).add(Aspect.ELDRITCH, 8).add(Aspect.WEAPON, 8),
        ...
        InfusionEnchantmentRecipe magicTouchEnch = new InfusionEnchantmentRecipe(
                ...
                2,
                new AspectList().add(Aspect.MAGIC, 8).add(Aspect.AURA, 8).add(Aspect.WEAPON, 8),
        ...
        InfusionEnchantmentRecipe vaporisingEnch = new InfusionEnchantmentRecipe(
                ...
                2,
                new AspectList().add(Aspect.MAGIC, 8).add(Aspect.CRYSTAL, 8).add(Aspect.TRAP, 8),
                new ItemStack[] { new ItemStack(ConfigItems.itemResource, 1, 14),
        ...
        CrucibleRecipe thauminiteRec = new CrucibleRecipe(
                ...
                new AspectList().add(Aspect.METAL, 4).add(Aspect.CRYSTAL, 8).add(Aspect.MAGIC, 2));
        ...
        if (Loader.isModLoaded("gregtech")) {
            ...
            for (int i = 0; i < 6; ++i) shards[i] = new CrucibleRecipe(
                    ...
                    new AspectList().add(Aspect.ENTROPY, 2).add(Aspect.MAGIC, 1).add(getPrimalForLoop(i), 3));
        }
        ...
        for (int i = 0; i < 7; ++i) if (i < 6) cBlocks[i] = new CrucibleRecipe(
                ...
                new AspectList().add(primals(1)).add(Aspect.CRAFT, 2).add(getPrimalForLoop(i), 2));
        else cBlocks[i] = new CrucibleRecipe(
                "TB.CrystalBlocks",
                new ItemStack(TBBlocks.crystalBlock, 1, i),
                new ItemStack(ConfigBlocks.blockCrystal, 1, i),
                new AspectList().add(primals(1)).add(Aspect.CRAFT, 2).add(primals(1)));
        ...
        for (int i = 0; i < 7; ++i) if (i < 6) cTaintedBlocks[i] = new CrucibleRecipe(
                ...
                new ItemStack(ConfigBlocks.blockCrystal, 1, i),
                new AspectList().add(primals(1)).add(Aspect.CRAFT, 2).add(getPrimalForLoop(i), 2).add(Aspect.TAINT, 2));
        else cTaintedBlocks[i] = new CrucibleRecipe(
                "TB.CrystalBlocks",
                new ItemStack(TBBlocks.crystalBlock, 1, 7),
                new ItemStack(ConfigBlocks.blockCrystal, 1, i),
                new AspectList().add(primals(1)).add(Aspect.CRAFT, 2).add(primals(1)).add(Aspect.TAINT, 2));
        ...
        InfusionRecipe voidRodRecipe = new InfusionRecipe(
                ...
                new AspectList().add(Aspect.ELDRITCH, 64).add(Aspect.VOID, 64).add(Aspect.MAGIC, 64)
                        .add(Aspect.AURA, 24).add(Aspect.ENERGY, 24),
                new ItemStack(TBItems.resource, 1, 3),
        ...
        InfusionRecipe drainFociRec = new InfusionRecipe(
                ...
                0,
                new AspectList().add(Aspect.WATER, 3).add(Aspect.VOID, 6),
        ...
        InfusionRecipe expFociRec = new InfusionRecipe(
                ...
                5,
                new AspectList().add(Aspect.GREED, 32).add(Aspect.VOID, 32).add(Aspect.MIND, 16).add(Aspect.HUNGER, 32)
                        .add(Aspect.MINE, 8),
                new ItemStack(ConfigItems.itemFocusExcavation, 1, 0),
        ...
        InfusionRecipe fluxFociRec = new InfusionRecipe(
                ...
                3,
                new AspectList().add(Aspect.WATER, 16).add(Aspect.VOID, 16).add(Aspect.ORDER, 16),
                new ItemStack(Items.diamond, 1, 0),
                new ItemStack[] { new ItemStack(ConfigItems.itemShard, 1, 6),
                        new ItemStack(ConfigItems.itemShard, 1, 6), new ItemStack(ConfigBlocks.blockStoneDevice, 1, 14),
        ...
        InfusionRecipe activationFociRec = new InfusionRecipe(
                ...
                0,
                new AspectList().add(Aspect.TRAVEL, 8).add(Aspect.SENSES, 8).add(Aspect.MOTION, 8),
        ...
        ShapedArcaneRecipe advFurnaceRecipe = new ShapedArcaneRecipe(
                ...
                new AspectList().add(Aspect.WATER, 20).add(Aspect.FIRE, 20).add(Aspect.AIR, 10),
                new Object[] { "# #", "#@#", "$$$", '#', new ItemStack(ConfigItems.itemResource, 1, 2), '@',
        ...
        InfusionRecipe cryingObsidianRec = new InfusionRecipe(
                ...
                2,
                new AspectList().add(Aspect.TRAVEL, 16).add(Aspect.LIFE, 16).add(Aspect.SOUL, 16),
                new ItemStack(Blocks.obsidian),
                new ItemStack[] { new ItemStack(Items.diamond), new ItemStack(Items.bed),
                        new ItemStack(TBBlocks.oldLapis), new ItemStack(TBBlocks.oldLapis) });

        InfusionRecipe overchanterRec = new InfusionRecipe(
                "TB.Overchanter",
                new ItemStack(TBBlocks.overchanter, 1, 0),
                4,
                new AspectList().add(primals(32)).add(Aspect.MAGIC, 32).add(Aspect.MECHANISM, 32).add(Aspect.MIND, 16),
                new ItemStack(Blocks.enchanting_table),
                new ItemStack[] { new ItemStack(TBBlocks.crystalBlock, 1, 0),
                        new ItemStack(TBBlocks.crystalBlock, 1, 1), new ItemStack(TBBlocks.crystalBlock, 1, 2),
                        new ItemStack(TBBlocks.crystalBlock, 1, 3), new ItemStack(TBBlocks.crystalBlock, 1, 4),
                        new ItemStack(TBBlocks.crystalBlock, 1, 5), new ItemStack(TBBlocks.crystalBlock, 1, 6),
                        new ItemStack(TBBlocks.crystalBlock, 1, 6), new ItemStack(TBBlocks.dustBlock, 1, 0),
                        new ItemStack(TBBlocks.dustBlock, 1, 0), new ItemStack(ConfigBlocks.blockCosmeticSolid, 1, 4),
        ...
        ShapedArcaneRecipe relocatorRec = new ShapedArcaneRecipe(
                ...
                new AspectList().add(Aspect.AIR, 5).add(Aspect.EARTH, 15).add(Aspect.WATER, 5),
                new Object[] { "GAG", "ENE", "GWG", 'G', new ItemStack(ConfigBlocks.blockWoodenDevice, 1, 6), 'A',
                        "shardAir", 'E', "shardEarth", 'W', "shardWater", 'N',
        ...
        InfusionRecipe voidAnvilRec = new InfusionRecipe(
                ...
                3,
                new AspectList().add(Aspect.CRAFT, 32).add(Aspect.TOOL, 24).add(Aspect.WEAPON, 24)
                        .add(Aspect.ORDER, 48),
        ...
        ShapedArcaneRecipe campfireRec = new ShapedArcaneRecipe(
                ...
                new AspectList().add(Aspect.FIRE, 5).add(Aspect.ENTROPY, 3),
        ...
        new ResearchItem(
                ...
                2,
                0,
                new ItemStack(TBBlocks.quicksilverBlock, 1, 0))
        ...
        new ResearchItem(
                "TB.AdvancedEntropy",
                catName,
                new AspectList().add(Aspect.ENTROPY, 3).add(Aspect.MAGIC, 3).add(Aspect.CRAFT, 3),
                -3,
                2,
                1,
                new ItemStack(Items.blaze_powder, 1, 0))
        ...
        new ResearchItem(
                "TB.AlchemyRestoration",
                catName,
                new AspectList().add(Aspect.ORDER, 3).add(Aspect.MAGIC, 3).add(Aspect.CRAFT, 3),
                -3,
                4,
                1,
                new ItemStack(Blocks.packed_ice, 1, 0))
        ...
        new ResearchItem(
                "TB.Pyrofluid",
                catName,
                new AspectList().add(Aspect.FIRE, 16).add(Aspect.MAGIC, 6).add(Aspect.ELDRITCH, 8).add(Aspect.GREED, 6),
                1,
                6,
                4,
        ...
        new ResearchItem(
                ...
                5,
                1,
                new ItemStack(TBBlocks.crystalBlock, 1, OreDictionary.WILDCARD_VALUE))
        ...
        new ResearchItem(
                "TB.Backprocessing",
                catName,
                new AspectList().add(Aspect.ORDER, 8).add(Aspect.EXCHANGE, 8).add(Aspect.CRAFT, 8),
                -6,
                3,
                1,
                new ItemStack(Items.reeds, 1, 0)).setParents("TB.AlchemyRestoration", "TB.AdvancedEntropy")
                        .setSecondary().setConcealed()
                        .setPages(
        ...
        new ResearchItem(
                "TB.MasterEntropy",
                catName,
                new AspectList().add(Aspect.ENTROPY, 8).add(Aspect.MAGIC, 4).add(Aspect.GREED, 2),
                -5,
                1,
                3,
        ...
        new ResearchItem(
                "TB.StrongEntropy",
                catName,
                new AspectList().add(Aspect.ENTROPY, 2).add(Aspect.WEAPON, 2),
                -1,
                1,
                3,
                new ItemStack(Blocks.sand, 1, 0))
                        .setParents("TB.AdvancedEntropy").setSecondary()
                        .setPages(
        ...
        new ResearchItem(
                "TB.SimpleDublication",
                catName,
                new AspectList().add(Aspect.EXCHANGE, 6).add(Aspect.ORDER, 6),
                3,
                5,
                1,
                new ItemStack(Items.arrow, 1, 0))
                        .setParents("TB.CRUCIBLE").setSecondary()
                        .setPages(
        ...
        new ResearchItem(
                "TB.Amber",
                catName,
                new AspectList().add(Aspect.TRAP, 6).add(Aspect.ORDER, 6),
                3,
                4,
                1,
                new ItemStack(ConfigItems.itemResource, 1, 6)).setParents("TB.CRUCIBLE").setSecondary()
        ...
        new ResearchItem(
                "TB.Quicksilver",
                catName,
                new AspectList().add(Aspect.TREE, 6).add(Aspect.ORDER, 6),
                3,
                2,
                1,
                new ItemStack(ConfigItems.itemResource, 1, 3)).setParents("TB.CRUCIBLE").setSecondary()
        ...
        new ResearchItem(
                "TB.Thauminite",
                catName,
                new AspectList().add(Aspect.METAL, 4).add(Aspect.MAGIC, 3).add(Aspect.CRYSTAL, 8).add(Aspect.CRAFT, 2),
                6,
                -1,
                2,
                new ItemStack(TBItems.resource, 1, 1))
                        .setParents("TB.THAUMIUM").setConcealed()
                        .setPages(
        ...
        new ResearchItem(
                "ROD_tbthaumium",
                catName,
                new AspectList().add(Aspect.METAL, 4).add(Aspect.MAGIC, 3).add(Aspect.AURA, 4).add(Aspect.CRAFT, 2)
                        .add(Aspect.MAN, 6),
                10,
                -1,
                2,
                new ItemStack(TBItems.resource, 1, 3)).setParents("TB.THAUMIUM").setConcealed()
        ...
        new ResearchItem(
                "ROD_tbvoid",
                catName,
                new AspectList().add(Aspect.ELDRITCH, 4).add(Aspect.MAGIC, 3).add(Aspect.AURA, 4).add(Aspect.VOID, 2)
                        .add(Aspect.MIND, 6),
                13,
                -1,
                4,
                new ItemStack(TBItems.resource, 1, 4)).setParents("ROD_tbthaumium", "TB.VOIDMETAL").setConcealed()
                        .setSpecial()
        ...
        new ResearchItem(
                "CAP_thauminite",
                catName,
                new AspectList().add(Aspect.METAL, 4).add(Aspect.MAGIC, 3).add(Aspect.AURA, 4),
                5,
                0,
                2,
                new ItemStack(TBItems.resource, 1, 2)).setParents("TB.Thauminite").setConcealed()
        ...
        new ResearchItem(
                "TB.SMB",
                catName,
                new AspectList().add(primals(6)).add(Aspect.CRAFT, 2),
                4,
                3,
                1,
                new ItemStack(TBBlocks.dustBlock)).setParents("TB.SM").setConcealed()
        ...
        new ResearchItem(
                "TB.OreDestruction",
                catName,
                new AspectList().add(Aspect.ENTROPY, 8).add(Aspect.MAGIC, 4).add(Aspect.ORDER, 1).add(Aspect.FIRE, 1)
                        .add(Aspect.AIR, 1).add(Aspect.EARTH, 1).add(Aspect.WATER, 1),
                -7,
                1,
                3,
        ...
        new ResearchItem(
                ...
                new ResourceLocation("thaumicbases", "textures/enchantments/elder_knowledge.png"))
                        .setParents("TB.INFUSIONENCHANTMENT").setSecondary().setConcealed()
        ...
        new ResearchItem(
                ...
                new ResourceLocation("thaumicbases", "textures/enchantments/magic_touched.png"))
                        .setParents("TB.INFUSIONENCHANTMENT").setSecondary().setConcealed()
                        .setPages(
                                new ResearchPage("tb.rec.enchantments.magictouched"),
        ...
        new ResearchItem(
                "TB.Foci.Drain",
                catName,
                new AspectList().add(Aspect.WATER, 6).add(Aspect.VOID, 3),
                -3,
                -2,
                0,
                new ItemStack(TBItems.fociDrain)).setParents("TB.INFUSION")
                        .setParentsHidden("FOCUSEXCAVATION", "JARVOID").setConcealed().setSecondary()
                        .setPages(
        ...
        new ResearchItem(
                "TB.Foci.Experience",
                catName,
                new AspectList().add(Aspect.GREED, 16).add(Aspect.HUNGER, 16).add(Aspect.MINE, 2).add(Aspect.MIND, 8),
                -2,
                -5,
                1,
                new ItemStack(TBItems.fociExperience)).setParents("TB.INFUSION").setParentsHidden("FOCUSEXCAVATION")
                        .setConcealed()
                        .setPages(
        ...
        new ResearchItem(
                "TB.Foci.Flux",
                catName,
                new AspectList().add(Aspect.WATER, 4).add(Aspect.ORDER, 4).add(Aspect.VOID, 4),
                -2,
                -1,
                0,
                new ItemStack(TBItems.fociFlux)).setParents("TB.INFUSION").setParentsHidden("JARVOID", "FLUXSCRUB")
        ...
        new ResearchItem(
                "TB.Foci.Activation",
                catName,
                new AspectList().add(Aspect.TRAVEL, 4).add(Aspect.MOTION, 4).add(Aspect.SENSES, 4),
                -3,
                -4,
                0,
                new ItemStack(TBItems.fociActivation)).setParents("TB.INFUSION").setParentsHidden("MIRRORHAND")
                        .setConcealed().setSecondary()
                        .setPages(
        ...
        new ResearchItem(
                "TB.AdvAlc",
                catName,
                new AspectList().add(Aspect.MOTION, 16).add(Aspect.AIR, 16).add(Aspect.FIRE, 8).add(Aspect.CRAFT, 4),
                8,
                2,
                2,
        ...
        new ResearchItem(
                "TB.CryingObs",
                catName,
                new AspectList().add(Aspect.TRAVEL, 8).add(Aspect.LIFE, 8).add(Aspect.SOUL, 8),
                3,
                -4,
                2,
                new ItemStack(TBBlocks.cryingObsidian, 1, 0)).setParents("TB.INFUSION").setConcealed()
        ...
        new ResearchItem(
                "TB.Overchanter",
                catName,
                new AspectList().add(primals(8)).add(Aspect.MIND, 8).add(Aspect.MAGIC, 8),
                -5,
                -3,
                3,
                new ItemStack(TBBlocks.overchanter, 1, 0))
                        .setParents("TB.INFUSION").setConcealed()
                        .setPages(
        ...
        new ResearchItem(
                "TB.Relocator",
                catName,
                new AspectList().add(Aspect.MOTION, 4).add(Aspect.AIR, 4).add(Aspect.VOID, 4),
                6,
                7,
                1,
                new ItemStack(TBBlocks.relocator, 1, 0))
                        .setParents("TB.LEVITATOR").setConcealed()
                        .setPages(
        ...
        new ResearchItem(
                "TB.ThaumicAnvil",
                catName,
                new AspectList().add(Aspect.METAL, 4).add(Aspect.CRAFT, 3),
                10,
                2,
                2,
                new ItemStack(TBBlocks.thaumicAnvil, 1, 0)).setParents("TB.THAUMIUM").setConcealed()
        ...
        new ResearchItem(
                "TB.VoidAnvil",
                catName,
                new AspectList().add(Aspect.METAL, 4).add(Aspect.CRAFT, 3).add(Aspect.TOOL, 4).add(Aspect.ELDRITCH, 4),
                13,
                2,
                2,
                new ItemStack(TBBlocks.voidAnvil, 1, 0))
                        .setParents("TB.VOIDMETAL", "TB.ThaumicAnvil").setConcealed()
                        .setPages(
        ...
        new ResearchItem(
                "TB.Campfire",
                catName,
                new AspectList().add(Aspect.FIRE, 3).add(Aspect.MIND, 3).add(Aspect.ENTROPY, 3),
                9,
                5,
                1,
        ...
        new ResearchItem(
                "TB.Brazier",
                catName,
                new AspectList().add(Aspect.FIRE, 3).add(Aspect.MIND, 3).add(Aspect.ENTROPY, 3).add(Aspect.MAGIC, 3)
                        .add(Aspect.MOTION, 3),
                9,
                7,
                0,
                new ItemStack(TBBlocks.braizer, 1, 0)).setParents("TB.Campfire").setSecondary()
        ...
        if (TBConfig.allowTobacco) {
            ...
            ShapelessArcaneRecipe saturatingTobaccoRec = new ShapelessArcaneRecipe(
                    ...
                    new AspectList().add(Aspect.EARTH, 10).add(Aspect.FIRE, 10).add(Aspect.WATER, 10),
            ...
            CrucibleRecipe tobaccoSeedRec = new CrucibleRecipe(
                    ...
                    new AspectList().add(Aspect.MIND, 4).add(Aspect.WATER, 4).add(Aspect.MAN, 4).add(Aspect.CROP, 4));
            ...
            ShapelessArcaneRecipe pestleRecipe = new ShapelessArcaneRecipe(
                    ...
                    TBItems.mortar,
                    new AspectList().add(primals(4)),
                    new Object[] { new ItemStack(Items.bowl), new ItemStack(Items.stick),
            ...
            new ResearchItem(
                    "TB.Tobacco",
                    catName,
                    new AspectList().add(Aspect.CROP, 4).add(Aspect.HARVEST, 4).add(Aspect.MAN, 4).add(Aspect.MIND, 4),
                    11,
                    -7,
                    3,
                    new ItemStack(TBItems.greatwoodPipe, 1, 0))
                            .setParentsHidden("TB.Plax").setConcealed()
                            .setPages(
            ...
            InfusionRecipe silverwoodPipeRec = new InfusionRecipe(
                    ...
                    4,
                    new AspectList().add(Aspect.AURA, 8).add(Aspect.ORDER, 32).add(Aspect.HEAL, 16),
                    new ItemStack(TBItems.greatwoodPipe, 1, 0),
                    new ItemStack[] { new ItemStack(ConfigItems.itemResource, 1, 14),
                            new ItemStack(ConfigItems.itemResource, 1, 14),
                            new ItemStack(ConfigItems.itemResource, 1, 14),
            ...
            new ResearchItem(
                    "TB.SilverwoodPipe",
                    catName,
                    new AspectList().add(Aspect.ORDER, 8).add(Aspect.HEAL, 8).add(Aspect.AURA, 8),
                    13,
                    -9,
                    1,
                    new ItemStack(TBItems.silverwoodPipe, 1, 0)).setParents("TB.Tobacco")
                            .setParentsHidden("TB.INFUSION").setConcealed()
            ...
            InfusionRecipe eldritchTobacoRec = new InfusionRecipe(
                    ...
                    1,
                    new AspectList().add(Aspect.ELDRITCH, 4).add(Aspect.DEATH, 1),
                    new ItemStack(TBItems.tobacco, 1, 0),
            ...
            InfusionRecipe wispyTobaccoRec = new InfusionRecipe(
                    ...
                    1,
                    new AspectList().add(Aspect.AURA, 4).add(Aspect.MAGIC, 6),
                    new ItemStack(TBItems.tobacco, 1, 0),
                    new ItemStack[] { new ItemStack(ConfigItems.itemResource, 1, 14),
            ...
            CrucibleRecipe angryTobaccoRec = new CrucibleRecipe(
                    ...
                    new ItemStack(TBItems.tobacco, 1, 0),
                    new AspectList().add(Aspect.WEAPON, 4).add(Aspect.HUNGER, 4));
            CrucibleRecipe miningTobaccoRec = new CrucibleRecipe(
                    "TB.Tobacco.Mining",
                    new ItemStack(TBItems.tobacco, 1, 5),
                    new ItemStack(TBItems.tobacco, 1, 0),
                    new AspectList().add(Aspect.MINE, 4).add(Aspect.MOTION, 4));
            CrucibleRecipe wisdomTobaccoRec = new CrucibleRecipe(
                    "TB.Tobacco.Wisdom",
                    new ItemStack(TBItems.tobacco, 1, 4),
                    new ItemStack(TBItems.tobacco, 1, 0),
                    new AspectList().add(Aspect.MIND, 4).add(Aspect.AIR, 4));
            CrucibleRecipe taintTobaccoRec = new CrucibleRecipe(
                    "TB.Tobacco.Tainted",
                    new ItemStack(TBItems.tobacco, 1, 7),
                    new ItemStack(TBItems.tobacco, 1, 0),
                    new AspectList().add(Aspect.TAINT, 4).add(Aspect.MIND, 4));
            ShapelessArcaneRecipe sanityTobaccoRec = new ShapelessArcaneRecipe(
                    "TB.Tobacco.Sanity",
                    new ItemStack(TBItems.tobacco, 1, 6),
                    new AspectList().add(Aspect.ORDER, 10).add(Aspect.AIR, 10).add(Aspect.ENTROPY, 10),
                    new Object[] { new ItemStack(TBItems.tobacco, 1, 0) });

            new ResearchItem(
                    "TB.Tobacco.Eldritch",
                    catName,
                    new AspectList().add(Aspect.DEATH, 4).add(Aspect.ELDRITCH, 4),
                    14,
                    -7,
                    0,
                    new ItemStack(TBItems.tobacco, 1, 1)).setParents("TB.Tobacco").setParentsHidden("TB.INFUSION")
                            .setConcealed().setSecondary()
            ...
            new ResearchItem(
                    "TB.Tobacco.Wispy",
                    catName,
                    new AspectList().add(Aspect.AURA, 4).add(Aspect.MAGIC, 4),
                    15,
                    -9,
                    0,
                    new ItemStack(TBItems.tobacco, 1, 8)).setParents("TB.Tobacco").setParentsHidden("TB.INFUSION")
                            .setConcealed().setSecondary()
            ...
            new ResearchItem(
                    ...
                    -9,
                    0,
                    new ItemStack(TBItems.tobacco, 1, 2)).setParents("TB.Tobacco").setConcealed().setSecondary()
            ...
            new ResearchItem(
                    ...
                    -7,
                    0,
                    new ItemStack(TBItems.tobacco, 1, 5)).setParents("TB.Tobacco").setConcealed().setSecondary()
            ...
            new ResearchItem(
                    ...
                    -6,
                    0,
                    new ItemStack(TBItems.tobacco, 1, 4)).setParents("TB.Tobacco").setConcealed().setSecondary()
            ...
            new ResearchItem(
                    "TB.Tobacco.Tainted",
                    catName,
                    new AspectList().add(Aspect.MIND, 4).add(Aspect.TAINT, 4),
                    15,
                    -8,
                    0,
                    new ItemStack(TBItems.tobacco, 1, 7)).setParents("TB.Tobacco").setConcealed().setSecondary()
            ...
            new ResearchItem(
                    "TB.Tobacco.Saturating",
                    catName,
                    new AspectList().add(Aspect.FLESH, 4).add(Aspect.HUNGER, 4),
                    10,
                    -9,
                    0,
                    new ItemStack(TBItems.tobacco, 1, 3))
                            .setParents("TB.Tobacco").setConcealed().setSecondary()
                            .setPages(
                                    new ResearchPage("tb.rec.stobacco.page.0"),
                                    new ResearchPage(
                                            new ShapelessArcaneRecipe[] { saturatingTobaccoRec,
                                                    saturatingTobaccoRecM }))
                            .registerResearchItem();

            new ResearchItem(
                    "TB.Tobacco.Sanity",
                    catName,
                    new AspectList().add(Aspect.ORDER, 4).add(Aspect.MIND, 4),
                    9,
                    -8,
                    0,
                    new ItemStack(TBItems.tobacco, 1, 6)).setParents("TB.Tobacco").setConcealed().setSecondary()
        ...
        if (TBConfig.enableBloodyMess) {
            ...
            new ResearchItem(
                    "TB.Spike.Iron",
                    catName,
                    new AspectList().add(Aspect.WEAPON, 6).add(Aspect.HUNGER, 6).add(Aspect.METAL, 6),
                    10,
                    -3,
                    1,
                    new ItemStack(TBBlocks.spike, 1, 0))
            ...
            new ResearchItem(
                    "TB.Spike.Thaumic",
                    catName,
                    new AspectList().add(Aspect.WEAPON, 6).add(Aspect.MAGIC, 6).add(Aspect.MECHANISM, 6),
                    13,
                    -3,
                    1,
                    new ItemStack(TBBlocks.spike, 1, 2)).setConcealed().setParents("TB.Spike.Iron")
            ...
            new ResearchItem(
                    "TB.BloodyRobes",
                    catName,
                    new AspectList().add(Aspect.HUNGER, 6).add(Aspect.FLESH, 6).add(Aspect.ARMOR, 6),
                    12,
                    -4,
                    1,
                    new ItemStack(TBItems.bloodyChest, 1, 0))
                            .setConcealed().setParents("TB.Spike.Iron")
                            .setPages(
            ...
            new ResearchItem(
                    "TB.Spike.Void",
                    catName,
                    new AspectList().add(Aspect.WEAPON, 6).add(Aspect.ELDRITCH, 6).add(Aspect.ARMOR, 6),
                    15,
                    -2,
                    2,
                    new ItemStack(TBBlocks.spike, 1, 4)).setConcealed().setParents("TB.Spike.Thaumic")
        ...
        if (TBConfig.enableBracelets) {
            ...
            ShapedArcaneRecipe ironBraceletRec = new ShapedArcaneRecipe(
                    ...
                    primals(1),
                    new Object[] { "CIC", "N N", 'C', new ItemStack(ConfigItems.itemWandCap, 1, 0), 'I', "ingotIron",
                            'N', "nuggetIron" });
            ...
            ShapedArcaneRecipe goldBraceletRec = new ShapedArcaneRecipe(
                    ...
                    primals(5),
                    new Object[] { "CIC", "N N", 'C', new ItemStack(ConfigItems.itemWandCap, 1, 1), 'I', "ingotGold",
                            'N', "nuggetGold" });
            ...
            InfusionRecipe silverwoodBraceletRec = new InfusionRecipe(
                    ...
                    new ItemStack[] { new ItemStack(ConfigItems.itemWandCap, 1, 2),
                            ...
                            new ItemStack(ConfigItems.itemWandCap, 1, 2), new ItemStack(ConfigItems.itemShard, 1, 6),
                            new ItemStack(ConfigBlocks.blockMagicalLog, 1, 1),
                            new ItemStack(ConfigBlocks.blockCrystal, 1, 6) });
            ...
            InfusionRecipe voidBraceletRec = new InfusionRecipe(
                    ...
                    new ItemStack(TBItems.resource, 1, 4),
                    new ItemStack[] { new ItemStack(ConfigItems.itemWandCap, 1, 2),
                            new ItemStack(TBBlocks.dustBlock, 1, 0), new ItemStack(ConfigItems.itemResource, 1, 16),
                            new ItemStack(TBBlocks.crystalBlock, 1, 6), new ItemStack(ConfigItems.itemWandCap, 1, 2),
                            new ItemStack(TBBlocks.dustBlock, 1, 0), new ItemStack(ConfigItems.itemResource, 1, 16),
            ...
            InfusionRecipe reedBraceletRec = new InfusionRecipe(
                    ...
                    2,
                    new AspectList().add(Aspect.AIR, 24).add(Aspect.MOTION, 12).add(Aspect.MAGIC, 8),
            ...
            InfusionRecipe boneBraceletRec = new InfusionRecipe(
                    ...
                    2,
                    new AspectList().add(Aspect.ENTROPY, 24).add(Aspect.UNDEAD, 12).add(Aspect.MAGIC, 8),
            ...
            InfusionRecipe obsidianBraceletRec = new InfusionRecipe(
                    ...
                    2,
                    new AspectList().add(Aspect.EARTH, 24).add(Aspect.DARKNESS, 12).add(Aspect.MAGIC, 8),
            ...
            InfusionRecipe blazeBraceletRec = new InfusionRecipe(
                    ...
                    2,
                    new AspectList().add(Aspect.FIRE, 24).add(Aspect.BEAST, 12).add(Aspect.MAGIC, 8),
            ...
            InfusionRecipe iceBraceletRec = new InfusionRecipe(
                    ...
                    2,
                    new AspectList().add(Aspect.WATER, 24).add(Aspect.COLD, 12).add(Aspect.MAGIC, 8),
            ...
            InfusionRecipe quartzBraceletRec = new InfusionRecipe(
                    ...
                    2,
                    new AspectList().add(Aspect.ORDER, 24).add(Aspect.ENERGY, 12).add(Aspect.MAGIC, 8),
            ...
            new ResearchItem(
                    "TB.Bracelet.Gold",
                    catName,
                    new AspectList().add(Aspect.METAL, 3).add(Aspect.MAGIC, 3).add(Aspect.GREED, 3),
                    -8,
                    8,
                    0,
                    new ItemStack(TBItems.castingBracelet, 1, 1))
            ...
            new ResearchItem(
                    "TB.Bracelet.Greatwood",
                    catName,
                    new AspectList().add(Aspect.TREE, 3).add(Aspect.MAGIC, 3).add(Aspect.ENERGY, 3),
                    -10,
                    8,
                    0,
            ...
            new ResearchItem(
                    "TB.Bracelet.Thaumium",
                    catName,
                    new AspectList().add(Aspect.METAL, 3).add(Aspect.MAGIC, 3).add(Aspect.ENERGY, 3)
                            .add(Aspect.AURA, 3),
                    -10,
                    11,
                    0,
                    new ItemStack(TBItems.castingBracelet, 1, 3)).setConcealed().setParents("TB.Bracelet.Greatwood")
            ...
            new ResearchItem(
                    "TB.Bracelet.Silverwood",
                    catName,
                    new AspectList().add(Aspect.ORDER, 3).add(Aspect.MAGIC, 3).add(Aspect.TREE, 3).add(Aspect.AURA, 3)
            ...
            new ResearchItem(
                    "TB.Bracelet.Void",
                    catName,
                    new AspectList().add(Aspect.VOID, 3).add(Aspect.MAGIC, 3).add(Aspect.ELDRITCH, 3)
                            .add(Aspect.AURA, 3).add(Aspect.EXCHANGE, 3),
                    -12,
                    11,
                    3,
                    new ItemStack(TBItems.castingBracelet, 1, 11)).setConcealed().setParents("TB.Bracelet.Silverwood")
                            .setParentsHidden("TB.VOIDMETAL")
                            .setPages(
            ...
            new ResearchItem(
                    "TB.Bracelet.Reed",
                    catName,
                    new AspectList().add(Aspect.AIR, 3).add(Aspect.MAGIC, 3).add(Aspect.CRAFT, 3).add(Aspect.AURA, 3)
                            .add(Aspect.EXCHANGE, 3),
                    -19,
                    6,
                    2,
                    new ItemStack(TBItems.castingBracelet, 1, 5)).setConcealed().setParents("TB.ROD_reed")
            ...
            new ResearchItem(
                    "TB.Bracelet.Blaze",
                    catName,
                    new AspectList().add(Aspect.FIRE, 3).add(Aspect.MAGIC, 3).add(Aspect.CRAFT, 3).add(Aspect.AURA, 3)
                            .add(Aspect.EXCHANGE, 3),
                    -15,
                    6,
                    2,
                    new ItemStack(TBItems.castingBracelet, 1, 8)).setConcealed().setParents("TB.ROD_blaze")
                            .setParentsHidden("TB.Bracelet.Greatwood")
                            .setPages(
            ...
            new ResearchItem(
                    "TB.Bracelet.Obsidian",
                    catName,
                    new AspectList().add(Aspect.EARTH, 3).add(Aspect.MAGIC, 3).add(Aspect.CRAFT, 3).add(Aspect.AURA, 3)
                            .add(Aspect.EXCHANGE, 3),
                    -19,
                    10,
                    2,
                    new ItemStack(TBItems.castingBracelet, 1, 7)).setConcealed().setParents("TB.ROD_obsidian")
                            .setParentsHidden("TB.Bracelet.Greatwood")
                            .setPages(
            ...
            new ResearchItem(
                    "TB.Bracelet.Ice",
                    catName,
                    new AspectList().add(Aspect.WATER, 3).add(Aspect.MAGIC, 3).add(Aspect.CRAFT, 3).add(Aspect.AURA, 3)
                            .add(Aspect.EXCHANGE, 3),
                    -17,
                    6,
                    2,
                    new ItemStack(TBItems.castingBracelet, 1, 9)).setConcealed().setParents("TB.ROD_ice")
                            .setParentsHidden("TB.Bracelet.Greatwood")
            ...
            new ResearchItem(
                    "TB.Bracelet.Quartz",
                    catName,
                    new AspectList().add(Aspect.ORDER, 3).add(Aspect.MAGIC, 3).add(Aspect.CRAFT, 3).add(Aspect.AURA, 3)
                            .add(Aspect.EXCHANGE, 3),
                    -17,
                    10,
                    2,
                    new ItemStack(TBItems.castingBracelet, 1, 10)).setConcealed().setParents("TB.ROD_quartz")
                            .setParentsHidden("TB.Bracelet.Greatwood")
                            .setPages(
            ...
            new ResearchItem(
                    ...
                    10,
                    2,
                    new ItemStack(TBItems.castingBracelet, 1, 6)).setConcealed().setParents("TB.ROD_bone")
                            .setParentsHidden("TB.Bracelet.Greatwood")
                            .setPages(
            ...
            new ResearchItem(
                    "TB.Bracelet.Primal",
                    catName,
                    primals(6).add(Aspect.MAGIC, 12).add(Aspect.ELDRITCH, 12),
                    -17,
                    8,
                    4,
                    new ItemStack(TBItems.castingBracelet, 1, 12))
        ...
        if (TBConfig.enableFlora) {
            ...
            CrucibleRecipe knowledgeFragmentRec = new CrucibleRecipe(
                    ...
                    new AspectList().add(Aspect.ORDER, 1).add(Aspect.EXCHANGE, 1));
            ...
            InfusionRecipe voidSeedRec = new InfusionRecipe(
                    ...
                    3,
                    new AspectList().add(Aspect.ELDRITCH, 16).add(Aspect.DARKNESS, 16).add(Aspect.CROP, 16),
            ...
            InfusionRecipe goldenOakRec = new InfusionRecipe(
                    ...
                    2,
                    new AspectList().add(Aspect.PLANT, 16).add(Aspect.GREED, 64),
            ...
            InfusionRecipe peacefulSaplingRec = new InfusionRecipe(
                    ...
                    new ItemStack(TBBlocks.sapling, 1, 1),
                    2,
                    new AspectList().add(Aspect.TREE, 16).add(Aspect.LIFE, 12).add(Aspect.HEAL, 6),
            ...
            InfusionRecipe netherSaplingRec = new InfusionRecipe(
                    ...
                    new ItemStack(TBBlocks.sapling, 1, 2),
                    5,
                    new AspectList().add(Aspect.TREE, 32).add(nether, 32).add(Aspect.HUNGER, 16),
                    ...
                    new ItemStack[] { new ItemStack(ConfigBlocks.blockCustomPlant, 1, 3),
                            ...
                            new ItemStack(ConfigBlocks.blockCustomPlant, 1, 3),
                            new ItemStack(ConfigBlocks.blockCustomPlant, 1, 3),
                            new ItemStack(ConfigItems.itemShard, 1, 1), new ItemStack(Items.lava_bucket, 1, 0),
                            new ItemStack(ConfigItems.itemShard, 1, 1),
                            new ItemStack(ConfigBlocks.blockCustomPlant, 1, 4) });
            ...
            InfusionRecipe enderSaplingRec = new InfusionRecipe(
                    ...
                    new ItemStack(TBBlocks.sapling, 1, 3),
                    7,
                    new AspectList().add(Aspect.TREE, 64).add(Aspect.ELDRITCH, 24).add(Aspect.VOID, 16)
                    ...
                    new ItemStack[] { new ItemStack(ConfigItems.itemShard, 1, 6),
                            ...
                            new ItemStack(ConfigItems.itemResource, 1, 1), new ItemStack(Items.ender_pearl, 1, 0),
                            new ItemStack(Items.ender_pearl, 1, 0), new ItemStack(ConfigBlocks.blockCustomPlant, 1, 4),
                            new ItemStack(ConfigItems.itemShard, 1, 6), new ItemStack(Items.ender_pearl, 1, 0),
                            new ItemStack(ConfigItems.itemShard, 1, 6),
                            new ItemStack(ConfigItems.itemResource, 1, 1) });
            ...
            new ResearchItem(
                    "TB.BasicPlants",
                    catName,
                    new AspectList().add(Aspect.CROP, 2).add(Aspect.PLANT, 2),
                    -8,
                    -2,
                    1,
                    new ItemStack(Items.wheat_seeds, 1, 0)).setParentsHidden("TB.CRUCIBLE").setRound()
            ...
            new ResearchItem(
                    "TB.Briar",
                    catName,
                    new AspectList().add(Aspect.CROP, 4).add(Aspect.PLANT, 4).add(Aspect.HEAL, 4),
                    -13,
                    -3,
                    1,
                    new ItemStack(TBItems.resource, 1, 6))
                            .setParents("TB.Plax").setConcealed()
                            .setPages(
            ...
            new ResearchItem(
                    "TB.Aurelia",
                    catName,
                    new AspectList().add(Aspect.LIFE, 6).add(Aspect.MAGIC, 6).add(Aspect.AURA, 6),
                    -10,
                    0,
                    0,
                    new ItemStack(TBBlocks.aurelia, 1, 0))
            ...
            new ResearchItem(
                    "TB.Knose",
                    catName,
                    new AspectList().add(Aspect.LIFE, 6).add(Aspect.MIND, 6).add(Aspect.EARTH, 6),
                    -10,
                    2,
                    0,
                    new ItemStack(TBItems.knoseFragment, 1, OreDictionary.WILDCARD_VALUE)).setParents("TB.Aurelia")
                            .setParentsHidden("TB.CrystalBlocks").setConcealed()
                            .setPages(
            ...
            new ResearchItem(
                    "TB.Ashroom",
                    catName,
                    new AspectList().add(Aspect.LIFE, 6).add(Aspect.ENTROPY, 6).add(Aspect.AURA, 6).add(Aspect.AIR, 6)
                            .add(Aspect.CROP, 4),
                    -9,
                    2,
                    2,
                    new ItemStack(TBBlocks.ashroom)).setParents("TB.Aurelia").setConcealed()
            ...
            new ResearchItem(
                    "TB.Glieonia",
                    catName,
                    new AspectList().add(Aspect.LIFE, 6).add(Aspect.LIGHT, 6).add(Aspect.SENSES, 6).add(Aspect.FIRE, 6)
                            .add(Aspect.PLANT, 4),
                    -12,
                    1,
                    2,
                    new ItemStack(TBItems.glieoniaSeed)).setParents("TB.Aurelia").setConcealed()
            ...
            new ResearchItem(
                    "TB.Flaxium",
                    catName,
                    new AspectList().add(Aspect.LIFE, 6).add(Aspect.ENTROPY, 6).add(Aspect.AURA, 6)
                            .add(Aspect.MAGIC, 6),
                    -11,
                    2,
                    2,
                    new ItemStack(TBBlocks.flaxium)).setParents("TB.Aurelia").setConcealed()
            ...
            new ResearchItem(
                    "TB.Metalleat",
                    catName,
                    new AspectList().add(Aspect.LIFE, 6).add(Aspect.MAGIC, 6).add(Aspect.METAL, 6)
            ...
            new ResearchItem(
                    "TB.Lazullia",
                    catName,
                    new AspectList().add(Aspect.LIFE, 6).add(Aspect.MAGIC, 6).add(Aspect.GREED, 6)
                            .add(Aspect.CRYSTAL, 6).add(Aspect.PLANT, 6).add(Aspect.SENSES, 8),
                    -8,
                    -5,
                    2,
                    new ItemStack(TBItems.lazulliaSeeds, 1, 0))
                            .setParents("TB.Metalleat").setConcealed()
                            .setPages(
                                    new ResearchPage(
                                            "tb.rec.lazullia.page.0"
                                                    + (Loader.isModLoaded("essentialcraft") ? "_ec3" : "")),
            ...
            new ResearchItem(
                    "TB.RainbowCacti",
                    catName,
                    new AspectList().add(Aspect.LIFE, 6).add(Aspect.MAGIC, 6).add(Aspect.EXCHANGE, 6)
                            .add(Aspect.CROP, 6).add(Aspect.ENTROPY, 6).add(Aspect.SENSES, 8),
                    -11,
                    -6,
                    2,
                    new ItemStack(TBBlocks.rainbowCactus, 1, 0)).setParents("TB.Metalleat").setConcealed()
            ...
            new ResearchItem(
                    "TB.Lucrite",
                    catName,
                    new AspectList().add(Aspect.GREED, 6).add(Aspect.MAGIC, 6).add(Aspect.PLANT, 6)
                            .add(Aspect.HUNGER, 6),
                    -9,
                    -6,
                    0,
                    new ItemStack(TBItems.lucriteSeeds, 1, 0)).setParents("TB.Metalleat").setParentsHidden("TB.SMB")
                            .setConcealed()
            ...
            new ResearchItem(
                    "TB.Redlon",
                    catName,
                    new AspectList().add(Aspect.LIFE, 6).add(Aspect.MECHANISM, 6).add(Aspect.ENERGY, 6)
                            .add(Aspect.CROP, 6).add(Aspect.ORDER, 6).add(Aspect.GREED, 8),
                    -10,
                    -6,
                    3,
                    new ItemStack(TBItems.redlonSeeds, 1, 0)).setParents("TB.Metalleat").setConcealed()
            ...
            new ResearchItem(
                    "TB.VoidSeed",
                    catName,
                    new AspectList().add(Aspect.LIFE, 6).add(Aspect.ELDRITCH, 6).add(Aspect.DARKNESS, 6),
                    16,
                    3,
                    1,
                    new ItemStack(TBItems.voidSeed, 1, 0)).setParents("TB.VOIDMETAL").setConcealed()
            ...
            new ResearchItem(
                    "TB.GoldenOak",
                    catName,
                    new AspectList().add(Aspect.GREED, 8).add(Aspect.HUNGER, 8).add(Aspect.CROP, 8),
                    -15,
                    -1,
                    0,
                    new ItemStack(TBBlocks.sapling, 1, 0)).setParents("TB.Briar").setParentsHidden("TB.INFUSION")
                            .setConcealed()
            ...
            new ResearchItem(
                    "TB.PeacefulSapling",
                    catName,
                    new AspectList().add(Aspect.LIFE, 8).add(Aspect.HEAL, 8).add(Aspect.TREE, 8),
                    -18,
                    -1,
                    0,
                    new ItemStack(TBBlocks.sapling, 1, 1))
                            .setParents("TB.GoldenOak").setConcealed()
                            .setPages(
            ...
            new ResearchItem(
                    "TB.NetherSapling",
                    catName,
                    new AspectList().add(Aspect.TREE, 8).add(Aspect.FIRE, 8).add(nether, 8),
                    -17,
                    0,
                    0,
                    new ItemStack(TBBlocks.sapling, 1, 2)).setParents("TB.GoldenOak").setConcealed()
            ...
            new ResearchItem(
                    "TB.EnderSapling",
                    catName,
                    new AspectList().add(Aspect.TREE, 8).add(Aspect.ELDRITCH, 8).add(Aspect.VOID, 8),
                    -17,
                    -2,
                    0,
                    new ItemStack(TBBlocks.sapling, 1, 3)).setParents("TB.GoldenOak").setConcealed()
        ...
        if (TBConfig.enableNodeTools) {
            ...
            InfusionRecipe nodeManipulatorRec = new InfusionRecipe(
                    ...
                    6,
                    new AspectList().add(Aspect.MECHANISM, 32).add(Aspect.AURA, 32).add(Aspect.MAGIC, 16)
                            .add(Aspect.ENERGY, 64).add(Aspect.VOID, 16),
            ...
            InfusionRecipe brightFociRec = new InfusionRecipe(
                    ...
                    3,
                    new AspectList().add(Aspect.AURA, flag ? 256 : 64).add(Aspect.LIGHT, flag ? 64 : 16)
            ...
            InfusionRecipe destructionFociRec = new InfusionRecipe(
                    ...
                    5,
                    new AspectList().add(Aspect.AURA, 64).add(Aspect.VOID, 16).add(Aspect.DEATH, 32),
                    new ItemStack(ConfigItems.itemResource, 1, 15),
                    new ItemStack[] { new ItemStack(ConfigItems.itemResource, 1, 6),
                            ...
                            new ItemStack(ConfigItems.itemFocusExcavation, 1, 0),
                            new ItemStack(ConfigItems.itemResource, 1, 6), new ItemStack(TBBlocks.crystalBlock, 1, 7),
            ...
            InfusionRecipe efficiencyFociRec = new InfusionRecipe(
                    ...
                    new ItemStack(ConfigItems.itemResource, 1, 15),
                    new ItemStack[] { new ItemStack(ConfigItems.itemShard, 1, 6),
                            new ItemStack(TBBlocks.dustBlock, 1, 0), new ItemStack(ConfigItems.itemShard, 1, 6),
                            new ItemStack(TBBlocks.dustBlock, 1, 0), new ItemStack(ConfigItems.itemShard, 1, 6),
                            new ItemStack(TBBlocks.dustBlock, 1, 0), new ItemStack(ConfigItems.itemShard, 1, 6),
                            new ItemStack(TBBlocks.dustBlock, 1, 0) });
            ...
            InfusionRecipe hungerFociRec = new InfusionRecipe(
                    ...
                    7,
                    new AspectList().add(Aspect.AURA, 64).add(Aspect.VOID, 64).add(Aspect.HUNGER, 256)
                            .add(Aspect.GREED, 64).add(Aspect.ENERGY, 128),
                    new ItemStack(ConfigItems.itemResource, 1, 15),
                    new ItemStack[] { new ItemStack(ConfigItems.itemResource, 1, 14),
            ...
            InfusionRecipe unstableFociRec = new InfusionRecipe(
                    ...
                    3,
                    new AspectList().add(Aspect.AURA, 64).add(Aspect.DEATH, 32).add(Aspect.ENTROPY, 64),
                    new ItemStack(ConfigItems.itemResource, 1, 15),
            ...
            InfusionRecipe pureFociRec = new InfusionRecipe(
                    ...
                    0,
                    new AspectList().add(Aspect.AURA, 64).add(Aspect.LIFE, 64).add(Aspect.ORDER, 64),
                    new ItemStack(ConfigItems.itemResource, 1, 15),
            ...
            InfusionRecipe sinisterFociRec = new InfusionRecipe(
                    ...
                    4,
                    new AspectList().add(Aspect.AURA, 64).add(Aspect.DARKNESS, 32).add(Aspect.UNDEAD, 64),
                    new ItemStack(ConfigItems.itemResource, 1, 15),
            ...
            InfusionRecipe speedFociRec = new InfusionRecipe(
                    ...
                    1,
                    new AspectList().add(Aspect.AURA, 64).add(Aspect.MOTION, 32).add(Aspect.MAGIC, 16),
                    new ItemStack(ConfigItems.itemResource, 1, 15),
                    new ItemStack[] { new ItemStack(TBBlocks.crystalBlock, 1, 6),
                            new ItemStack(TBBlocks.dustBlock, 1, 0), new ItemStack(TBBlocks.crystalBlock, 1, 6),
                            new ItemStack(TBBlocks.dustBlock, 1, 0), new ItemStack(TBBlocks.crystalBlock, 1, 6),
                            new ItemStack(TBBlocks.dustBlock, 1, 0), new ItemStack(TBBlocks.crystalBlock, 1, 6),
                            new ItemStack(TBBlocks.dustBlock, 1, 0) });
            ...
            InfusionRecipe stabilityFociRec = new InfusionRecipe(
                    ...
                    1,
                    new AspectList().add(Aspect.AURA, 64).add(Aspect.ORDER, 32).add(Aspect.EXCHANGE, 16),
                    new ItemStack(ConfigItems.itemResource, 1, 15),
            ...
            InfusionRecipe taintFociRec = new InfusionRecipe(
                    ...
                    5,
                    new AspectList().add(Aspect.AURA, 64).add(Aspect.TAINT, 64).add(Aspect.ENTROPY, 16),
                    new ItemStack(ConfigItems.itemResource, 1, 15),
                    new ItemStack[] { new ItemStack(ConfigItems.itemResource, 1, 11),
            ...
            new ResearchItem(
                    "TB.NodeMan",
                    catName,
                    new AspectList().add(Aspect.MECHANISM, 8).add(Aspect.AURA, 8).add(Aspect.ENERGY, 16)
                            .add(Aspect.MAGIC, 8),
                    0,
                    -8,
                    3,
                    new ItemStack(TBBlocks.nodeManipulator))
                            .setParents("TB.INFUSION", "TB.NODESTABILIZERADV", "TB.VISPOWER").setConcealed()
                            .setPages(
            ...
            new ResearchItem(
                    "TB.NodeFoci.Bright",
                    catName,
                    new AspectList().add(Aspect.AURA, 8).add(Aspect.LIGHT, 8),
                    0,
                    -11,
                    0,
                    new ItemStack(TBItems.nodeFoci, 1, 0)).setParents(bParents).setConcealed().setSecondary()
            ...
            new ResearchItem(
                    "TB.NodeFoci.Destr",
                    catName,
                    new AspectList().add(Aspect.AURA, 8).add(Aspect.DEATH, 8).add(Aspect.VOID, 8),
                    2,
                    -10,
                    0,
                    new ItemStack(TBItems.nodeFoci, 1, 1))
                            .setParents("TB.NodeMan").setConcealed().setSecondary()
                            .setPages(
            ...
            new ResearchItem(
                    "TB.NodeFoci.Efficiency",
                    catName,
                    new AspectList().add(Aspect.AURA, 8).add(Aspect.MAGIC, 8).add(Aspect.ENERGY, 8),
                    -4,
                    -8,
                    0,
                    new ItemStack(TBItems.nodeFoci, 1, 2))
            ...
            new ResearchItem(
                    "TB.NodeFoci.Hunger",
                    catName,
                    new AspectList().add(Aspect.AURA, 8).add(Aspect.HUNGER, 16).add(Aspect.ENERGY, 16),
                    4,
                    -9,
                    0,
                    new ItemStack(TBItems.nodeFoci, 1, 3)).setParents("TB.NodeMan").setConcealed().setSecondary()
                            .setSpecial()
            ...
            new ResearchItem(
                    "TB.NodeFoci.Unstable",
                    catName,
                    new AspectList().add(Aspect.AURA, 8).add(Aspect.ENTROPY, 8).add(Aspect.VOID, 8),
                    -2,
                    -10,
                    0,
                    new ItemStack(TBItems.nodeFoci, 1, 4))
            ...
            new ResearchItem(
                    "TB.NodeFoci.Purity",
                    catName,
                    new AspectList().add(Aspect.AURA, 8).add(Aspect.LIFE, 8).add(Aspect.ORDER, 8),
                    -1,
                    -11,
                    0,
                    new ItemStack(TBItems.nodeFoci, 1, 5)).setParents("TB.NodeMan").setConcealed().setSecondary()
            ...
            new ResearchItem(
                    "TB.NodeFoci.Sinister",
                    catName,
                    new AspectList().add(Aspect.AURA, 8).add(Aspect.UNDEAD, 8).add(Aspect.ENTROPY, 8),
                    -3,
                    -10,
                    0,
                    new ItemStack(TBItems.nodeFoci, 1, 6))
            ...
            new ResearchItem(
                    "TB.NodeFoci.Speed",
                    catName,
                    new AspectList().add(Aspect.AURA, 8).add(Aspect.MOTION, 8).add(Aspect.ENERGY, 8),
                    -4,
                    -9,
                    0,
                    new ItemStack(TBItems.nodeFoci, 1, 7)).setParents("TB.NodeMan").setConcealed().setSecondary()
            ...
            new ResearchItem(
                    "TB.NodeFoci.Stability",
                    catName,
                    new AspectList().add(Aspect.AURA, 8).add(Aspect.ORDER, 8).add(Aspect.EXCHANGE, 8),
                    1,
                    -11,
                    0,
                    new ItemStack(TBItems.nodeFoci, 1, 8))
            ...
            new ResearchItem(
                    "TB.NodeFoci.Taint",
                    catName,
                    new AspectList().add(Aspect.AURA, 8).add(Aspect.TAINT, 16).add(Aspect.ENERGY, 8),
                    3,
                    -10,
                    0,
                    new ItemStack(TBItems.nodeFoci, 1, 9)).setParents("TB.NodeMan").setConcealed().setSecondary()
            ...
            new ResearchItem(
                    "TB.NodeLinker",
                    catName,
                    new AspectList().add(Aspect.MECHANISM, 8).add(Aspect.AURA, 8).add(Aspect.TRAVEL, 16)
                            .add(Aspect.MAGIC, 8),
                    5,
                    -6,
                    3,
                    new ItemStack(TBBlocks.nodeLinker))
                            .setParents("TB.VISPOWER").setConcealed()
                            .setPages(
        ...
        if (TBConfig.enableRevolver) {
            ...
            InfusionRecipe revolverRec = new InfusionRecipe(
                    ...
                    5,
                    new AspectList().add(Aspect.WEAPON, 256).add(Aspect.METAL, 32).add(Aspect.TREE, 16)
                            .add(Aspect.TOOL, 12).add(Aspect.ENERGY, 32).add(Aspect.MECHANISM, 12).add(Aspect.VOID, 16)
                            .add(Aspect.FIRE, 32),
            ...
            RevolverInfusionRecipe accuracyRec = new RevolverInfusionRecipe(
                    ...
                    1,
                    new AspectList().add(Aspect.ORDER, 8).add(Aspect.SENSES, 8),
            ...
            RevolverInfusionRecipe atropodsRec = new RevolverInfusionRecipe(
                    ...
                    1,
                    new AspectList().add(Aspect.DEATH, 8).add(Aspect.BEAST, 8).add(Aspect.CLOTH, 8),
            ...
            RevolverInfusionRecipe eldritchBRec = new RevolverInfusionRecipe(
                    ...
                    2,
                    new AspectList().add(Aspect.DEATH, 8).add(Aspect.ELDRITCH, 8),
                    new ItemStack[] { new ItemStack(Items.ender_eye, 1, 0),
                            new ItemStack(ConfigItems.itemResource, 1, 14), new ItemStack(Items.ender_pearl, 1, 0) });

            RevolverInfusionRecipe duelingRec = new RevolverInfusionRecipe(
                    "TB.Revolver.Dueling",
                    RevolverUpgrade.dueling,
                    2,
                    new AspectList().add(Aspect.DEATH, 8).add(Aspect.MAN, 8),
            ...
            RevolverInfusionRecipe efficiencyRec = new RevolverInfusionRecipe(
                    ...
                    0,
                    new AspectList().add(Aspect.ORDER, 8).add(Aspect.EXCHANGE, 8),
                    new ItemStack[] { new ItemStack(ConfigItems.itemResource, 1, 14),
            ...
            RevolverInfusionRecipe eldritchRec = new RevolverInfusionRecipe(
                    ...
                    5,
                    new AspectList().add(Aspect.ELDRITCH, 8).add(Aspect.VOID, 8),
            ...
            RevolverInfusionRecipe heavyRec = new RevolverInfusionRecipe(
                    ...
                    0,
                    new AspectList().add(Aspect.WEAPON, 8).add(Aspect.METAL, 8),
                    new ItemStack[] { new ItemStack(ConfigItems.itemResource, 1, 14),
            ...
            RevolverInfusionRecipe knowledgeRec = new RevolverInfusionRecipe(
                    ...
                    0,
                    new AspectList().add(Aspect.MIND, 8).add(Aspect.AURA, 8),
            ...
            RevolverInfusionRecipe primalRec = new RevolverInfusionRecipe(
                    ...
                    12,
                    new AspectList().add(Aspect.WEAPON, 64).add(primals(64)).add(Aspect.MAGIC, 64),
                    new ItemStack[] { new ItemStack(ConfigItems.itemResource, 1, 14),
            ...
            ItemStack silver = OreDictionary.doesOreNameExist("ingotSilver")
                    ...
                    && OreDictionary.getOres("ingotSilver").size() > 0 ? OreDictionary.getOres("ingotSilver").get(0)
                            : new ItemStack(ConfigItems.itemResource, 1, 15);
            ...
            RevolverInfusionRecipe silverRec = new RevolverInfusionRecipe(
                    ...
                    0,
                    new AspectList().add(Aspect.DEATH, 8).add(Aspect.BEAST, 8).add(Aspect.UNDEAD, 8),
                    new ItemStack[] { new ItemStack(ConfigItems.itemResource, 1, 14),
            ...
            RevolverInfusionRecipe speedRec = new RevolverInfusionRecipe(
                    ...
                    2,
                    new AspectList().add(Aspect.MOTION, 8).add(Aspect.AIR, 8),
            ...
            RevolverInfusionRecipe taintedRec = new RevolverInfusionRecipe(
                    ...
                    4,
                    new AspectList().add(Aspect.TAINT, 8).add(Aspect.WEAPON, 8),
                    new ItemStack[] { new ItemStack(ConfigItems.itemResource, 1, 11),
                            new ItemStack(ConfigItems.itemResource, 1, 14),
                            new ItemStack(ConfigItems.itemResource, 1, 12),
                            new ItemStack(ConfigItems.itemResource, 1, 14) });
            ...
            RevolverInfusionRecipe voidRec = new RevolverInfusionRecipe(
                    ...
                    4,
                    new AspectList().add(Aspect.VOID, 8).add(Aspect.TOOL, 8),
                    new ItemStack[] { new ItemStack(ConfigItems.itemResource, 1, 16),
            ...
            new ResearchItem(
                    "TB.Revolver",
                    catName,
                    new AspectList().add(Aspect.WEAPON, 5).add(Aspect.FIRE, 5).add(Aspect.VOID, 4).add(Aspect.TOOL, 2)
                            .add(Aspect.ENERGY, 2),
                    -16,
                    -7,
                    4,
            ...
            new ResearchItem(
                    "TB.Revolver.Accuracy",
                    catName,
                    new AspectList().add(Aspect.ORDER, 8).add(Aspect.MECHANISM, 8).add(Aspect.SENSES, 4),
                    -19,
                    -7,
                    0,
                    new ResourceLocation("thaumicbases", "textures/thaumonomicon/revolver/ACCURACY.png"))
                            .setParents("TB.Revolver").setConcealed().setSecondary()
            ...
            new ResearchItem(
                    "TB.Revolver.Atropods",
                    catName,
                    new AspectList().add(Aspect.DEATH, 8).add(Aspect.BEAST, 8).add(Aspect.CLOTH, 4),
                    -14,
                    -10,
                    0,
            ...
            new ResearchItem(
                    "TB.Revolver.EldritchBane",
                    catName,
                    new AspectList().add(Aspect.DEATH, 8).add(Aspect.ELDRITCH, 4),
                    -13,
                    -8,
                    0,
            ...
            new ResearchItem(
                    "TB.Revolver.Knowledge",
                    catName,
                    new AspectList().add(Aspect.MIND, 8).add(Aspect.MAGIC, 8),
                    -18,
                    -10,
                    0,
            ...
            new ResearchItem(
                    "TB.Revolver.Piercing",
                    catName,
                    new AspectList().add(Aspect.WEAPON, 8).add(Aspect.AIR, 8),
                    -17,
                    -10,
                    0,
            ...
            new ResearchItem(
                    "TB.Revolver.Power",
                    catName,
                    new AspectList().add(Aspect.WEAPON, 8).add(Aspect.MECHANISM, 8),
                    -16,
                    -10,
                    0,
            ...
            new ResearchItem(
                    ...
                    new ResourceLocation("thaumicbases", "textures/thaumonomicon/revolver/PRIMAL.png"))
                            .setParents("TB.Revolver").setConcealed().setSecondary().setSpecial()
            ...
            new ResearchItem(
                    "TB.Revolver.Void",
                    catName,
                    new AspectList().add(Aspect.VOID, 8).add(Aspect.METAL, 8),
                    -19,
                    -5,
                    0,
        ...
        InfusionRecipe entityDeconstructorRec = new InfusionRecipe(
                ...
                4,
                new AspectList().add(Aspect.DEATH, 16).add(Aspect.SOUL, 4).add(Aspect.MIND, 16),
                ...
                new ItemStack[] { new ItemStack(Blocks.light_weighted_pressure_plate),
                        ...
                        new ItemStack(Blocks.heavy_weighted_pressure_plate),
                        new ItemStack(ConfigItems.itemResource, 1, 9), new ItemStack(ConfigItems.itemResource, 1, 9),
                        new ItemStack(ConfigItems.itemResource, 1, 15),
                        new ItemStack(ConfigItems.itemResource, 1, 15) });
        ...
        new ResearchItem(
                "TB.EntityDec",
                catName,
                new AspectList().add(Aspect.MIND, 8).add(Aspect.DEATH, 8).add(Aspect.SOUL, 8),
                3,
                -2,
                1,
                new ItemStack(TBBlocks.entityDeconstructor, 1, 0)).setParents("TB.INFUSION").setSecondary()
                        .setConcealed()
        ...
        new ResearchItem(
                "TB.EntityDecAdv",
                catName,
                new AspectList().add(Aspect.MIND, 8).add(Aspect.DEATH, 8),
                5,
                -3,
                1,
        ...
        for (int i = 0; i < 6; ++i) ThaumcraftApi.getCraftingRecipes().add(shards[i]);

        for (int i = 0; i < oldRec.length; ++i) ThaumcraftApi.getCraftingRecipes().add(oldRec[i]);

        for (int i = 0; i < 10; ++i) ThaumcraftApi.getCraftingRecipes().add(toolsRec[i]);
    ...
    public static AspectList primals(int amount) {
        return new AspectList().add(Aspect.AIR, amount).add(Aspect.WATER, amount).add(Aspect.EARTH, amount)
                .add(Aspect.FIRE, amount).add(Aspect.ORDER, amount).add(Aspect.ENTROPY, amount);
    }
