...
public class TBRecipes {
    ...
    public static void setup() {
        ...
        ShapelessOreRecipe qBl = new ShapelessOreRecipe(new ItemStack(TBBlocks.quicksilverBlock), new Object[] {
            "quicksilver",
            "quicksilver",
            "quicksilver",
            "quicksilver",
        ...
        ShapelessOreRecipe qSi = new ShapelessOreRecipe(
                new ItemStack(ConfigItems.itemResource, 9, 3), new Object[] {"blockQuicksilver"});
        ...
        ShapelessOreRecipe smB = new ShapelessOreRecipe(
                new ItemStack(ConfigItems.itemResource, 9, 14), new Object[] {"blockSalisMundus"});
        ShapelessOreRecipe tnU = new ShapelessOreRecipe(
                new ItemStack(TBItems.resource, 9, 0), new Object[] {new ItemStack(TBItems.resource, 1, 1)});
        ShapelessOreRecipe tnI = new ShapelessOreRecipe(new ItemStack(TBItems.resource, 1, 1), new Object[] {
        ...
        ShapelessOreRecipe tnB = new ShapelessOreRecipe(new ItemStack(TBBlocks.thauminiteBlock, 1, 0), new Object[] {
            "ingotThauminite",
            "ingotThauminite",
            "ingotThauminite",
            "ingotThauminite",
        ...
        ShapelessOreRecipe tiB =
                new ShapelessOreRecipe(new ItemStack(TBItems.resource, 9, 1), new Object[] {TBBlocks.thauminiteBlock});
        ShapelessOreRecipe biP = new ShapelessOreRecipe(
                new ItemStack(Blocks.planks, 4, 2), new Object[] {new ItemStack(TBBlocks.genLogs, 1, 0)});
        ShapelessOreRecipe spP = new ShapelessOreRecipe(
                new ItemStack(Blocks.planks, 4, 1), new Object[] {new ItemStack(TBBlocks.genLogs, 1, 1)});
        ShapelessOreRecipe enP = new ShapelessOreRecipe(
                new ItemStack(TBBlocks.enderPlanks, 4, 0), new Object[] {new ItemStack(TBBlocks.genLogs, 1, 2)});
        ...
        ShapedOreRecipe iGw = new ShapedOreRecipe(new ItemStack(TBBlocks.ironGreatwood, 5, 0), new Object[] {
            "@#@", "###", "@#@", '@', "nuggetIron", '#', new ItemStack(ConfigBlocks.blockWoodenDevice, 1, 6)
        });
        ...
        for (int i = 0; i < BlockHalfSlab.parents.length; ++i) {
            ShapedOreRecipe slabRec = new ShapedOreRecipe(
                    new ItemStack(TBBlocks.genericSlab, 6, i), new Object[] {"###", '#', BlockHalfSlab.parents[i]});
            slabs.add(slabRec);
