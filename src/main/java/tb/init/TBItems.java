...
public class TBItems {
    ...
    public static ArmorMaterial thauminiteA =
            EnumHelper.addArmorMaterial("ATHAUMINITE", 27, new int[] {3, 8, 6, 3}, 17);
    public static ArmorMaterial bloodyA = EnumHelper.addArmorMaterial("TBBLOODY", 21, new int[] {2, 6, 5, 2}, 21);

    public static Item thauminiteAxe = new ItemThauminiteAxe(thauminite)
            .setUnlocalizedName("thauminiteAxe")
            .setTextureName("thaumicbases:thauminite/thauminiteaxe");
    public static Item thauminiteHoe = new ItemThauminiteHoe(thauminite)
            .setUnlocalizedName("thauminiteHoe")
            .setTextureName("thaumicbases:thauminite/thauminitehoe");
    public static Item thauminitePickaxe = new ItemThauminitePickaxe(thauminite)
            .setUnlocalizedName("thauminitePickaxe")
            .setTextureName("thaumicbases:thauminite/thauminitepick");
    public static Item thauminiteShears = new ItemThauminiteShears()
            .setUnlocalizedName("thauminiteShears")
            .setTextureName("thaumicbases:thauminite/thauminiteshears")
            .setFull3D()
            .setMaxStackSize(1)
            .setMaxDamage(974);
    public static Item thauminiteShovel = new ItemThauminiteShovel(thauminite)
            .setUnlocalizedName("thauminiteShovel")
            .setTextureName("thaumicbases:thauminite/thauminiteshovel");
    public static Item thauminiteSword = new ItemThauminiteSword(thauminite)
            .setUnlocalizedName("thauminiteSword")
            .setTextureName("thaumicbases:thauminite/thauminitesword");

    public static Item thauminiteHelmet = new ItemThauminiteArmor(thauminiteA, 0)
            .setUnlocalizedName("thauminiteHelmet")
            .setTextureName("thaumicbases:thauminite/thauminitehelm");
    public static Item thauminiteChest = new ItemThauminiteArmor(thauminiteA, 1)
            .setUnlocalizedName("thauminiteChest")
            .setTextureName("thaumicbases:thauminite/thauminitechest");
    public static Item thauminiteLeggings = new ItemThauminiteArmor(thauminiteA, 2)
            .setUnlocalizedName("thauminiteLegs")
            .setTextureName("thaumicbases:thauminite/thauminitelegs");
    public static Item thauminiteBoots = new ItemThauminiteArmor(thauminiteA, 3)
            .setUnlocalizedName("thauminiteBoots")
            .setTextureName("thaumicbases:thauminite/thauminiteboots");

    public static Item pyroBucket = new ItemPyrofluidBucket()
            .setUnlocalizedName("pyrofluidBucket")
            .setTextureName("thaumicbases:bucket_blazing_fluid");

    public static Item plaxSeed = new ItemSeeds(TBBlocks.plax, Blocks.farmland)
            .setUnlocalizedName("plaxSeeds")
    ...
    // TODO ROSA
    public static Item knoseFragment =
            new ItemKnoseFragment().setUnlocalizedName("knoseFragment.").setTextureName("thaumicbases:knose/");
    ...
    public static Item sweedSeeds = new ItemKnoseSeeds(TBBlocks.sweed, Blocks.grass)
            .setUnlocalizedName("sweedSeeds")
    ...
    public static Item rosehipSyrup = new ItemRosehipSyrup()
            .setUnlocalizedName("rosehipSyrup")
            .setTextureName("thaumicbases:rosehip_syrup")
            .setMaxStackSize(16);
    public static Item voidSeed = new ItemSeeds(TBBlocks.voidPlant, Blocks.farmland)
            .setUnlocalizedName("voidSeed")
    ...
    public static Item mortar =
            new ItemMortarAndPestle().setUnlocalizedName("mortar").setTextureName("thaumicbases:mortar");
    public static Item tobacco = new TBTobacco().setUnlocalizedName("tobacco");
    public static Item greatwoodPipe =
            new ItemSmokingPipe(false).setUnlocalizedName("greatwoodPipe").setTextureName("thaumicbases:smokingPipe");
    public static Item silverwoodPipe = new ItemSmokingPipe(true)
            .setUnlocalizedName("silverwoodPipe")
            .setTextureName("thaumicbases:smokingPipe_silverwood");

    public static Item bloodyChest = new ItemBloodyArmor(bloodyA, 1)
            .setUnlocalizedName("bloodyChest")
            .setTextureName("thaumicbases:bloodyRobes/bloodychest");
    public static Item bloodyLeggings = new ItemBloodyArmor(bloodyA, 2)
            .setUnlocalizedName("bloodyLegs")
            .setTextureName("thaumicbases:bloodyRobes/bloodylegs");
    public static Item bloodyBoots = new ItemBloodyArmor(bloodyA, 3)
            .setUnlocalizedName("bloodyBoots")
            .setTextureName("thaumicbases:bloodyRobes/bloodyboots");

    public static Item concentratedTaint = new ItemConcentratedTaint()
            .setUnlocalizedName("concentratedTaint")
            .setTextureName("thaumicbases:concentratedTaint")
            .setMaxStackSize(1);

    public static Item fociActivation = new FociActivation()
            .setUnlocalizedName("activationFoci")
            .setTextureName("thaumicbases:foci/activation/foci");
    public static Item fociDrain =
            new FociDrain().setUnlocalizedName("drainFoci").setTextureName("thaumicbases:foci/drain/foci");
    public static Item fociExperience = new FociExperience()
            .setUnlocalizedName("experienceFoci")
            .setTextureName("thaumicbases:foci/experience/foci");
    public static Item fociFlux =
            new FociFlux().setUnlocalizedName("fluxFoci").setTextureName("thaumicbases:foci/flux/foci");

    public static Item nodeFoci = new ItemNodeFoci().setUnlocalizedName("nodeFoci.");

    public static Item voidShears = new ItemVoidShears()
            .setTextureName("thaumicbases:shears")
            .setUnlocalizedName("tb.voidShears")
            .setFull3D()
            .setMaxDamage(184)
            .setFull3D()
            .setMaxStackSize(1);
    public static Item voidFAS = new ItemVoidFlintAndSteel()
            .setTextureName("thaumicbases:flint_and_steel")
    ...
    public static Item revolver =
            new ItemRevolver().setMaxDamage(1561).setMaxStackSize(1).setFull3D().setUnlocalizedName("tb.revolver");
