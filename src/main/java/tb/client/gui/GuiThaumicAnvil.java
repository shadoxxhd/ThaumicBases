...
public class GuiThaumicAnvil extends GuiContainer implements ICrafting {
    ...
    private ContainerThaumicAnvil field_147092_v;
    private GuiTextField field_147091_w;
    private InventoryPlayer field_147094_x;

    public GuiThaumicAnvil(
            InventoryPlayer p_i1073_1_, World p_i1073_2_, int p_i1073_3_, int p_i1073_4_, int p_i1073_5_) {
        super(new ContainerThaumicAnvil(
