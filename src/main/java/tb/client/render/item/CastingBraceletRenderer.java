...
public class CastingBraceletRenderer implements IItemRenderer {
    ...
    public static ModelRenderer getWandFociModel() {
        try {
            ...
            if (!accessible) foci.setAccessible(false);
    ...
    public static Timer getMCTimer() {
        try {
            ...
            if (!timerField.isAccessible()) timerField.setAccessible(true);
    ...
    public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
        ...
        if (type == ItemRenderType.EQUIPPED) {
            ...
            if (wielder.isInvisible()) return;
        }

        if (type == ItemRenderType.ENTITY) GL11.glScaled(0.5D, 0.5D, 0.5D);
        ...
        if (focusStack != null) {
            ...
            if (Thaumcraft.isHalloween) UtilsFX.bindTexture("textures/models/spec_h.png");
            else UtilsFX.bindTexture("textures/models/wand.png");
